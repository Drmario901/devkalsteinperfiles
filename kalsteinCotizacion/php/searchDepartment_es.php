<?php 
    ...
    $consulta = "SELECT * FROM wp_categories ORDER BY categorie_description_es ASC";
	...
	if ($resultado->num_rows > 0) {
		while ($fila = $resultado->fetch_assoc()) {
			if (in_array($fila['categorie_description_es'], $categorys)){
			}else{
				array_push($categorys, $fila['categorie_description_es']);
			}
		}
