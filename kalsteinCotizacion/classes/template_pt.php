...
<div class='cp02'>
    ...
    <div class='h-02'>
        ...
        <div class='h-text-02'>
            ...
            <p class='lt-03'>Na Kalstein France, cuidamos da plena satisfação dos nossos clientes, razão pela qual prestamos serviços de valor acrescentado ao mais alto nível com base na nossa experiência.</p>
        </div>
    </div>
    <div class='p2img-01'>
    ...
    <div class='cmsj-01'>
        ...
        <div class='i-text'>
            ...
            <p class='i-p'>Em qualquer parte do mundo, receba sua indução ou treinamento de nossa equipe especializada de engenheiros.</p>
        </div>
    </div>
    <div class='cmsj-02'>
        <div class='i'>
        ...
        <div class='i-text'>
            ...
            <p class='i-p'>Nossa equipe de trabalho está sempre disponível para responder a todas as suas perguntas, a fim de ajudar em qualquer situação.</p>
        </div>
    </div>
    <div class='cmsj-03'>
        <div class='i'>
        ...
        <div class='i-text'>
            ...
            <p class='i-p'>Graças à sua compra, será feita uma doação a uma fundação sem fins lucrativos que combate o câncer de mama e ajuda as comunidades mais vulneráveis.</p>
        </div>
    </div>
    <div class='cmsj-04'>
        <div class='i'>
        ...
        <div class='i-text'>
            ...
            <p class='i-p'>Desfrute de conselhos personalizados para a correta manutenção preventiva e corretiva do seu equipamento, graças a manuais e artigos da Kalstein, catálogos especiais e tutoriais em vídeo.</p>
        </div>
    </div>
    <div class='cmsj-05'>
        <div class='i'>
        ...
        <div class='i-text'>
            ...
            <p class='i-p'>Nós cuidamos de toda a logística necessária para o envio de seus produtos, seja por mar, terra ou ar.</p>
        </div>
    </div>
    <div class='cmsj-06'>
        <div class='i'>
        ...
        <div class='i-text'>
            ...
            <p class='i-p'>Com mais de 25 anos crescendo com nossos clientes, o conteúdo moderno e multiformato da Kalstein está presente em mais de 10 países e crescendo.</p>
        </div>
    </div>
    <div class='f2-text'>
...
<page backtop="58mm" backbottom="30mm" backleft="0mm" backright="0mm"> 
    <page_header> 
        <div class='ht'>
            ...
            <div class='tp-02'>
                <p style='font-weight: bold; margin: 0; padding: 0;'>Citação N°: <span style='font-weight: lighter;'>QUO<?php echo $id?></span></p>
    ...
    <page_footer> 
        <div class='ft'>
            <div class='ft-01'>
                ...
                <div class='text-ce'>
                    <p style='margin: 0; padding: 0; font-weight: bold; font-size: 12px;'>Marcação CE: comprar com tranquilidade</p>
                    <p style='margin: 0; padding: 0; font-size: 10px; margin-top: 1mm;'>Todos os equipamentos Kalstein cumprem os requisitos da UE, em conformidade com a regulamentação pertinente.</p>
                </div>
                <div class='img-cora'>
                ...
                <div class='text-cora'>
                    <p style='margin: 0; padding: 0; font-weight: bold; font-size: 12px;'>Com a aquisição de um equipamento Kalstein</p>
                    <p style='margin: 0; padding: 0; font-size: 10px; margin-top: 1mm;'>YVocê contribui para a Fundação Convite de Jacinto, OneTreePlanted, Humatem Foundation e a Fundação Maniapure.</p>
                </div>
            </div>
            <div class='hr-05'></div>
            <div class='ft-02'>
            ...
            <div class='ob'>
                <div class='sob'>
                    <div class='ob-title'>
                        ...
                        <p style='font-weight: bold; font-size: 12px; margin: 0; padding: 0; text-align: right; margin-top: 2mm;'>Prazos de entrega:</p>
                        <p style='font-weight: bold; font-size: 12px; margin: 0; padding: 0; text-align: right; margin-top: 3mm;'>Representante de vendas:</p>
                        <p style='font-weight: bold; font-size: 12px; margin: 0; padding: 0; text-align: right; margin-top: 12mm;'>Termos comerciais:</p>
                    ...
                    <div class='ob-p'>
                        <p style='font-size: 12px; margin: 0; padding: 0; text-align: left; margin-top: 7mm; margin-left: 3mm;'>7 - 10 dias aprox..</p>
                        ...
                        <p style='font-size: 12px; margin: 0; padding: 0; text-align: left; margin-top: 3mm; margin-left: 3mm;'>Pagamento antecipado com Ordem de Compra.</p>
...
<page backtop="0mm" backbottom="0mm" backleft="0mm" backright="0mm">
    ...
    <div class='main-text'>
        <p style='margin: 0; padding: 0; color: #213280; font-weight: bold; font-size: 12px;'>ACEITAÇÃO DA ORDEM DE COMPRA</p>
        <div class='i-list'>
        ...
        <div class='i-txt'>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 3mm;'>A Kalstein France SAS recebe uma ordem de compra satisfatória, quando o presente documento exprime fielmente as condições comerciais estabelecidas na oferta.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>Pagamentos em numerário: Para o processamento e expedição da mercadoria solicitada, é necessária a verificação do pagamento nas contas bancárias da Kalstein France.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm; margin-left: 0.2mm;'>Clientes com Crédito: para o processamento e despacho da mercadoria solicitada, é necessária prova de pagamento em contas bancárias Kalstein France.</p>
        </div>
        <p style='margin: 0; padding: 0; color: #213280; font-weight: bold; font-size: 12px; margin-top: 10mm;'>MOEDA COMERCIAL</p>
        <div class='i-list'>
            <p style='text-align: center; margin: 0; padding: 0; margin-top: 3mm;'>•</p>
            <p style='text-align: center; margin: 0; padding: 0; margin-top: 6.5mm;'>•</p>
        </div>
        <div class='i-txt2'>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 3mm;'>Ofertas em moeda estrangeira, o cálculo da conversão cambial será realizado de acordo com as disposições do Banco de França, definidas no dia da faturação.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>A moeda comercial estabelecida para esta listagem é <?php echo $divisa?>.</p>
        </div>
        ...
        <div class='i-txt3'>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 3mm;'>Todos os equipamentos vendidos pela Kalstein France têm uma garantia de um ano para efeitos de fabrico a partir da data de faturação dos bens.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>A garantia não cobre danos causados por má instalação ou operação, defeitos de transporte ou por outros usos que não os especificados pelo fabricante.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>A garantia exclui peças elétricas ou consumíveis.</p>
        </div>
        <p style='margin: 0; padding: 0; color: #213280; font-weight: bold; font-size: 12px; margin-top: 5mm;'>PRAZOS DE ENTREGA</p>
        <div class='i-list'>
            <p style='text-align: center; margin: 0; padding: 0; margin-top: 7mm;'>•</p>
        </div>
        <div class='i-txt4'>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 3mm;'>Os prazos de entrega indicados nesta cotação são estimativas sujeitas a variáveis.</p>
        </div>
        <p style='margin: 0; padding: 0; color: #213280; font-weight: bold; font-size: 12px; margin-top: 7mm;'>CANCELAMENTOS E DEVOLUÇÕES SEM JUSTA CAUSA</p>
        <div class='i-list'>
            <p style='text-align: center; margin: 0; padding: 0; margin-top: 3mm;'>•</p>
        ...
        <div class='i-txt5'>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 3mm;'>A mercadoria em estoque terá penalidade equivalente a 20% do valor da ordem de compra.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>IImportar Mercadoria, depois de receber a ordem de compra a contento, há um máximo de (3) dias para cancelar a ordem de compra, depois desse tempo os cancelamentos não são aceitos e a mercadoria será faturada conforme estabelecido.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>A devolução da mercadoria ficará a cargo do Cliente, da caixa, da embalagem e de todas as peças que compõem o equipamento a ser devolvido, devendo estar em perfeitas condições, sem maus-tratos, arranhões e etiquetas adicionais, realizando o relatório técnico da equipe de Suporte Técnico e Logística Kalstein France e indicando o recebimento satisfatório da mercadoria. Se não for recebido de forma satisfatória, o equipamento será faturado de acordo com as disposições do Pedido de compra.</p>
        </div>
...
<page backtop="0mm" backbottom="0mm" backleft="0mm" backright="0mm">
    ...
    <div class='logo-05'>
        ...
        <p style='margin: 0; padding: 0; color: #213280; font-size: 9px; margin-top: -2mm; margin-left: 28mm;'>Um acompanhamento diferente, ao seu serviço</p>
    </div>
    <div class='img-loc'>
    ...
    <div class='img-cont'>
        <img src="https://dev.kalstein.plus/plataforma/en/wp-content/plugins/kalsteinCotizacion/assets/images/FAQ_PT.png" style='float: left; width: 100%; height: 100%;'>
    </div>   
    <div class='f-last'>
