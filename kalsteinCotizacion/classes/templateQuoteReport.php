...
<div class='cp01'>
    <div class='h-01'>
        <img src="https://dev.kalstein.plus/plataforma/wp-content/plugins/kalsteinCotizacion/assets/images/francia-pais.jpg"
            style='float: right; width: 18%; margin-top: 25mm; margin-right: 45mm;'>
    </div>
    <div class='b-01'
        style='background-image: url(https://dev.kalstein.plus/plataforma/wp-content/plugins/kalsteinCotizacion/assets/images/fondo.png)'>
        <div class='id'>
            <div class='logo'>
                <img src="https://dev.kalstein.plus/plataforma/wp-content/plugins/kalsteinCotizacion/assets/images/logo.png"
        ...
        <div class='f-01'>
            <div class='qr'>
                <img src="https://dev.kalstein.plus/plataforma/wp-content/plugins/kalsteinCotizacion/assets/images/qr.jpg"
                    style='width: 100%;'>
            </div>
            <div class='f-text'>
            ...
            <div class='hr-2'></div>
            <div class='img-logo2'>
                <img src="https://dev.kalstein.plus/plataforma/wp-content/plugins/kalsteinCotizacion/assets/images/logo-blanco.png"
...
<page backtop="58mm" backbottom="30mm" backleft="0mm" backright="0mm">
    ...
    <page_footer>
        <div class='ft'>
            <div class='ft-01'>
                <div class='img-ce'>
                    <img src="https://dev.kalstein.plus/plataforma/wp-content/plugins/kalsteinCotizacion/assets/images/img-ce.jpg"
                ...
                <div class='img-cora'>
                    <img src="https://dev.kalstein.plus/plataforma/wp-content/plugins/kalsteinCotizacion/assets/images/icono3.png"
