...
<div class='cp02'>
    ...
    <div class='h-02'>
        ...
        <div class='h-text-02'>
            ...
            <p class='lt-03'>En Kalstein France, nos ocupamos de la plena sastifacción de nuestros clientes, es por eso que brindamos servicios de valor agregado del más alto nivel basados en nuestra experiencia.</p>
        </div>
    </div>
    <div class='p2img-01'>
    ...
    <div class='cmsj-01'>
        ...
        <p class='i-title'>Inducciones y Entrenamientos Online</p>
            <p class='i-p'>En cualquier parte del mundo, reciba su inducción o capacitación de nuestro equipo especializado de ingenieros.</p>
        </div>
    </div>
    <div class='cmsj-02'>
        <div class='i'>
        ...
        <p class='i-title'>Rápida Respuesta</p>
            <p class='i-p'>Nuestro equipo de trabajo siempre está disponible para responder a todas sus consultas o preguntas, con el fin de ayudarlo en cualquier situación.</p>
        </div>
    </div>
    <div class='cmsj-03'>
        <div class='i'>
        ...
        <div class='i-text'>
            ...
            <p class='i-p'>Gracias a su compra, se hará una donación a una fundación sin fines de lucro que lucha contra el cáncer de seno y ayuda a las comunidades más vulnerables.</p>
        </div>
    </div>
    <div class='cmsj-04'>
        <div class='i'>
        ...
        <p class='i-title1'>Soporte Técnico</p>
            <p class='i-p'>Disfrute de asesoramiento personalizado para el correcto mantenimiento preventivo y correctivo de su equipo, gracias a los manuales y artículos de Kalstein, catálogos especiales y video tutoriales.</p>
        </div>
    </div>
    <div class='cmsj-05'>
        <div class='i'>
        ...
        <p class='i-title2'>Logísticas de Envío</p>
            <p class='i-p'>Nos ocupamos de toda la logística necesaria para el envío de sus productos, ya sea por mar, tierra o aire.</p>
        </div>
    </div>
    <div class='cmsj-06'>
        <div class='i'>
        ...
        <p class='i-title3'>Kalstein a Nivel Mundial</p>
            <p class='i-p'>Con más de 25 años creciendo con nuestros clientes, el contenido multiformato y moderno de Kalstein ahora está presente en más de 10 países y sigue aumentando.</p>
        </div>
    </div>
    <div class='f2-text'>
        <p class='t-1'>Todos los derechos reservados ® KALSTEIN France S. A. S.,</p>
    </div>
    <div class='style-03'><p style='text-align: right; color: #fff; font-size: 9px; margin-right: 12mm; margin-top: 6.5mm; font-weight: bold;'>Página [[page_cu]] de [[page_nb]]</p></div>
    ...
    <page_footer> 
        <div class='ft'>
            <div class='ft-01'>
                ...
                <div class='text-ce'>
                <p style='margin: 0; padding: 0; font-weight: bold; font-size: 12px;'>Marcado CE: para comprar con tranquilidad</p>
                    <p style='margin: 0; padding: 0; font-size: 10px; margin-top: 1mm;'>Todos los equipos de Kalstein cumplen con los requisitos de la UE, de acuerdo con las regulaciones pertinentes.</p>
                </div>
                <div class='img-cora'>
                ...
                <div class='text-cora'>
                <p style='margin: 0; padding: 0; font-weight: bold; font-size: 12px;'>Con la adquision de un equipo Kalstein</p>
                    <p style='margin: 0; padding: 0; font-size: 10px; margin-top: 1mm;'>Usted hace una contribucion a la Fundacion Jacinto Convit, OneTreePlanted, Humatem Foundation y la Fundacion Maniapure.</p>
                </div>
            </div>
            <div class='hr-05'></div>
            <div class='ft-02'>
            ...
            <div class='ob'>
                <div class='sob'>
                    <div class='ob-title'>
                        ...
                        <p style='font-weight: bold; font-size: 12px; margin: 0; padding: 0; text-align: right; margin-top: 2mm;'>Tiempo de entrega:</p>
                        <p style='font-weight: bold; font-size: 12px; margin: 0; padding: 0; text-align: right; margin-top: 3mm;'>Representante de ventas:</p>
                        <p style='font-weight: bold; font-size: 12px; margin: 0; padding: 0; text-align: right; margin-top: 12mm;'>Terminos comerciales:</p>
                    ...
                    <div class='ob-p'>
                        <p style='font-size: 12px; margin: 0; padding: 0; text-align: left; margin-top: 7mm; margin-left: 3mm;'>7 - 10 días aprox.</p>
                        ...
                        <p style='font-size: 12px; margin: 0; padding: 0; text-align: left; margin-top: 3mm; margin-left: 3mm;'>Pago anticipado con orden de compra.</p>
...
<page backtop="0mm" backbottom="0mm" backleft="0mm" backright="0mm">
    ...
    <div class='main-text'>
        <p style='margin: 0; padding: 0; color: #213280; font-weight: bold; font-size: 12px;'>ACEPTACIÓN DE ORDEN DE COMPRA</p>
        <div class='i-list'>
        ...
        <div class='i-txt'>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 3mm;'>Kalstein France SAS recibe a satisfacción la orden de compra, cuando este documento expresa fielmente las condiciones comerciales establecidas en la oferta.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>Pagos de contado: Para el trámite y despacho de la mercancía solicitada, es requerida la comprobación de pago en cuentas bancarias de Kalstein France.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm; margin-left: 0.2mm;'>Clientes con Crédito: Para el trámite y despacho de la mercancía solicitada, es requerida la comprobación de pago en cuentas bancarias de Kalstein France.</p>
        </div>
        <p style='margin: 0; padding: 0; color: #213280; font-weight: bold; font-size: 12px; margin-top: 10mm;'>MONEDA DE NEGOCIACIÓN</p>
        <div class='i-list'>
            <p style='text-align: center; margin: 0; padding: 0; margin-top: 3mm;'>•</p>
            <p style='text-align: center; margin: 0; padding: 0; margin-top: 6.5mm;'>•</p>
        </div>
        <div class='i-txt2'>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 3mm;'>Ofertas en moneda extranjera, se realizará el cálculo de conversión de moneda de acuerdo a lo establecido por el Banco de Francia, fijado el día de la facturación.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>La moneda de negociacion establecida para la presente cotizacion es <?php echo $divisa?>.</p>
        </div>
        <p style='margin: 0; padding: 0; color: #213280; font-weight: bold; font-size: 12px; margin-top: 5mm;'>GARANTIA</p>
        <div class='i-list'>
            <p style='text-align: center; margin: 0; padding: 0; margin-top: 3mm;'>•</p>
            <p style='text-align: center; margin: 0; padding: 0; margin-top: 6.5mm;'>•</p>
            <p style='text-align: center; margin: 0; padding: 0; margin-top: 6.5mm;'>•</p>
        ...
        <div class='i-txt3'>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 3mm;'>Todos los equipos comercializados por Kalstein France, tienen garantía de un año pordefectos de fabricación a partir de la fecha de la facturacion de la mercancía.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>La garantía no cubre daños causados por mala instalación u operacion, defectos portransporte o por usos diferentes a los especificados por el fabricante.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>La garantia excluye partes electricas o consumibles.</p>
        </div>
        <p style='margin: 0; padding: 0; color: #213280; font-weight: bold; font-size: 12px; margin-top: 5mm;'>TIEMPOS DE ENTREGA</p>
        <div class='i-list'>
            <p style='text-align: center; margin: 0; padding: 0; margin-top: 3mm;'>•</p>
        </div>
        <div class='i-txt4'>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 3mm;'>Los tiempos de entrega indicados en esta cotizacion son estimaciones sujetas a variables.</p>
        </div>
        <p style='margin: 0; padding: 0; color: #213280; font-weight: bold; font-size: 12px; margin-top: 7mm;'>CANCELACIONES Y DEVOLUCIONES SIN JUSTA CAUSA</p>
        <div class='i-list'>
            <p style='text-align: center; margin: 0; padding: 0; margin-top: 3mm;'>•</p>
        ...
        <div class='i-txt5'>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 3mm;'>Mercancía en inventario, tendrá una penalización equivalente al 20% del valor de la orden de compra.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>Mercancía de Importación, después de recibida la orden de compra a satisfacción se disponede un máximo de (3) días para la cancelación de la orden de compra, pasado este tiempo no se aceptan cancelaciones y la mercancía será facturada conforme a lo establecido.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>La devolución de la mercancía será responsabilidad del Cliente, la caja, envoltorios y todas las partes que conforman el equipo a devolver, deberán estar en perfectas condiciones sin maltrato, rayas y etiquetas adicionales, el equipo de Soporte técnico y logística de Kalstein France, realizará informe técnico e indicará el recibo a satisfacción de la mercancía. De no ser recibida a satisfacción se facturará el equipo conforme a lo establecido en la Orden de compra.</p>
        </div>
        <p style='margin: 0; padding: 0; color: #213280; font-weight: bold; font-size: 12px; margin-top: 22mm;'>POLÍTICAS, TÉRMINOS Y CONDICIONES GENERALES</p>
        <p style='margin: 0; padding: 0; font-size: 11px; margin-top: 1mm;'>https://kalstein.eu/p12/Terms-and-Conditions/pages.html</p>
    </div>
    <div class='style-07'><p style='text-align: right; color: #fff; font-size: 9px; margin-right: 12mm; margin-top: 6.5mm; font-weight: bold;'>Página [[page_cu]] de [[page_nb]]</p></div>
...
<page backtop="0mm" backbottom="0mm" backleft="0mm" backright="0mm">
    ...
    <div class='logo-05'>
        ...
        <p style='margin: 0; padding: 0; color: #213280; font-size: 9px; margin-top: -2mm; margin-left: 28mm;'>Un acompañamiento diferente, a su servicio</p>
    </div>
    <div class='img-loc'>
    ...
    <div class='img-cont'>
        <img src="https://dev.kalstein.plus/plataforma/en/wp-content/plugins/kalsteinCotizacion/assets/images/FAQ_ES.png" style='float: left; width: 100%; height: 100%;'>
    </div>   
    <div class='f-last'>
