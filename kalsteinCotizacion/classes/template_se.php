...
<div class='cp02'>
    ...
    <div class='h-02'>
        ...
        <div class='h-text-02'>
            ...
            <p class='lt-03'>På Kalstein France tar vi hand om våra kunders fulla tillfredsställelse, det är därför vi tillhandahåller mervärdestjänster på högsta nivå baserat på vår erfarenhet.</p>
        </div>
    </div>
    <div class='p2img-01'>
    ...
    <div class='cmsj-01'>
        ...
        <div class='i-text'>
            ...
            <p class='i-p'>I alla delar av världen, ta emot din introduktion eller utbildning från vårt specialiserade team av ingenjörer.</p>
        </div>
    </div>
    <div class='cmsj-02'>
        <div class='i'>
        ...
        <div class='i-text'>
            ...
            <p class='i-p'>Vårt arbetsteam är alltid tillgängligt för att svara på alla dina frågor eller frågor, för att hjälpa till i alla situationer.</p>
        </div>
    </div>
    <div class='cmsj-03'>
        <div class='i'>
        ...
        <div class='i-text'>
            ...
            <p class='i-p'>Tack vare ditt köp kommer en donation att göras till en ideell stiftelse som bekämpar bröstcancer och hjälper de mest utsatta grupperna.</p>
        </div>
    </div>
    <div class='cmsj-04'>
        <div class='i'>
        ...
        <div class='i-text'>
            ...
            <p class='i-p'>Njut av personlig rådgivning för korrekt förebyggande och korrigerande underhåll av din utrustning, tack vare Kalstein manualer och artiklar, särskilda kataloger och video handledningar.</p>
        </div>
    </div>
    <div class='cmsj-05'>
        <div class='i'>
        ...
        <div class='i-text'>
            ...
            <p class='i-p'>Vi tar hand om all logistik som krävs för att frakta dina produkter, oavsett om det sker till sjöss, på land eller med flyg.</p>
        </div>
    </div>
    <div class='cmsj-06'>
        <div class='i'>
        ...
        <div class='i-text'>
            ...
            <p class='i-p'>Med över 25 års tillväxt med våra kunder finns Kalsteins moderna innehåll i flera format nu i över 10 länder och växer.</p>
        </div>
    </div>
    <div class='f2-text'>
        <p class='t-1'>Med ensamrätt ® KALSTEIN France S. A. S.,</p>
    </div>
    <div class='style-03'><p style='text-align: right; color: #fff; font-size: 9px; margin-right: 12mm; margin-top: 6.5mm; font-weight: bold;'>Sidan [[page_cu]] av [[page_nb]]</p></div>
...
<page backtop="58mm" backbottom="30mm" backleft="0mm" backright="0mm"> 
    <page_header> 
        <div class='ht'>
            ...
            <div class='tp-02'>
                <p style='font-weight: bold; margin: 0; padding: 0;'>Offert N°: <span style='font-weight: lighter;'>QUO<?php echo $id?></span></p>
    ...
    <page_footer> 
        <div class='ft'>
            <div class='ft-01'>
                ...
                <div class='text-ce'>
                    <p style='margin: 0; padding: 0; font-weight: bold; font-size: 12px;'>CE-märkning: att köpa med sinnesro</p>
                    <p style='margin: 0; padding: 0; font-size: 10px; margin-top: 1mm;'>All Kalsteinutrustning uppfyller EU:s krav i enlighet med relevanta bestämmelser.</p>
                </div>
                <div class='img-cora'>
                ...
                <div class='text-cora'>
                    <p style='margin: 0; padding: 0; font-weight: bold; font-size: 12px;'>Med förvärvet av en Kalstein-utrustning</p>
                    <p style='margin: 0; padding: 0; font-size: 10px; margin-top: 1mm;'>Du bidrar till Jacinto Convit Foundation, OneTreePlanted, Humatem Foundation och Maniapure Foundation.</p>
                </div>
            </div>
            <div class='hr-05'></div>
            <div class='ft-02'>
                ...
                <div class='ftn-3'>
                    <p style='text-align: right; font-size: 9px; margin-top: 6.5mm; font-weight: bold;'>Sidan [[page_cu]] av [[page_nb]]</p>
                </div>
            </div>
        </div>
    </page_footer>
        ...
        <div class='sbt-02'>
            <div class='ob'>
                <div class='sob'>
                    <div class='ob-title'>
                        ...
                        <p style='font-weight: bold; font-size: 12px; margin: 0; padding: 0; text-align: right; margin-top: 2mm;'>Leveranstider:</p>
                        <p style='font-weight: bold; font-size: 12px; margin: 0; padding: 0; text-align: right; margin-top: 3mm;'>Säljare:</p>
                        <p style='font-weight: bold; font-size: 12px; margin: 0; padding: 0; text-align: right; margin-top: 12mm;'>Handelsvillkor:</p>
                    ...
                    <div class='ob-p'>
                        <p style='font-size: 12px; margin: 0; padding: 0; text-align: left; margin-top: 7mm; margin-left: 3mm;'>7 - 10 dagar ca.</p>
                        ...
                        <p style='font-size: 12px; margin: 0; padding: 0; text-align: left; margin-top: 3mm; margin-left: 3mm;'>Förskottsbetalning med inköpsorder.</p>
            ...
            <div class='totales'>
                <div class='subtotales'>
                    <div class='totales-t'>
                        <p style='font-weight: bold; font-size: 12px; margin: 0; padding: 0; text-align: right;'>Delsumma:</p>
...
<page backtop="0mm" backbottom="0mm" backleft="0mm" backright="0mm">
    ...
    <div class='main-text'>
        <p style='margin: 0; padding: 0; color: #213280; font-weight: bold; font-size: 12px;'>GODKÄNNANDE AV INKÖPSORDER</p>
        <div class='i-list'>
        ...
        <div class='i-txt'>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 3mm;'>Kalstein France SAS får en köpordertillfredsställelse, när detta dokument troget uttrycker de kommersiella villkor som fastställs i erbjudandet.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>Kontantbetalningar: För hantering och avsändande av de begärda varorna krävs kontroll av betalning på Kalstein Frances bankkonton.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm; margin-left: 0.2mm;'>Kunder med kredit: För behandling och avsändning av de begärda varorna krävs betalningsbevis i Kalstein France bankkonton.</p>
        </div>
        ...
        <div class='i-txt2'>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: -3mm;'>Anbud i utländsk valuta, valutakonverteringen kommer att utföras i enlighet med bestämmelserna i Bank of France, som fastställts på fakturadagen.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>Den etablerade handelsvalutan för denna notering är <?php echo $divisa?>.</p>
        </div>
        <p style='margin: 0; padding: 0; color: #213280; font-weight: bold; font-size: 12px; margin-top: 5mm;'>GARANTI</p>
        <div class='i-list'>
            <p style='text-align: center; margin: 0; padding: 0; margin-top: 3mm;'>•</p>
            <p style='text-align: center; margin: 0; padding: 0; margin-top: 4mm;'>•</p>
        ...
        <div class='i-txt3'>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: -6.5mm;'>All utrustning som säljs av Kalstein France har ett års garanti för tillverkningsändamål från och med fakturadatumet för varorna.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>Garantin omfattar inte skador som orsakats av dålig installation eller drift, transportdefekter eller av andra användningsområden än de som anges av tillverkaren.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>Garantin gäller inte reservdelar eller förbrukningsartiklar.</p>
        </div>
        <p style='margin: 0; padding: 0; color: #213280; font-weight: bold; font-size: 12px; margin-top: 5mm;'>LEVERANSTIDER</p>
        <div class='i-list'>
            <p style='text-align: center; margin: 0; padding: 0; margin-top: 3mm;'>•</p>
        </div>
        <div class='i-txt4'>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: -10mm;'>De leveranstider som anges i denna offert är uppskattningar som omfattas av variabler.</p>
        </div>
        <p style='margin: 0; padding: 0; color: #213280; font-weight: bold; font-size: 12px; margin-top: 7mm;'>AVBOKNINGAR OCH RETURER UTAN SKÄLIG ORSAK</p>
        <div class='i-list'>
            <p style='text-align: center; margin: 0; padding: 0; margin-top: 3mm;'>•</p>
        ...
        <div class='i-txt5'>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: -10mm;'>Varor i lager kommer att ha en straffavgift som motsvarar 20% av värdet på inköpsordern.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>Importera varor, efter att ha mottagit inköpsordern till belåtenhet, det finns ett maximum av (3) dagar för att annullera inköpsordern, efter denna tid annulleringar inte accepteras och varorna kommer att faktureras som etablerade.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>Återlämnandet av varorna kommer att vara kundens ansvar, lådan, förpackningen och alla delar som utgör utrustningen som ska returneras, måste vara i perfekt skick utan misshandel, repor och ytterligare etiketter, Kalstein Frankrike teknisk support och logistik team, utföra teknisk rapport och kommer att ange tillfredsställande mottagande av varorna. Om utrustningen inte tas emot på ett tillfredsställande sätt kommer den att faktureras i enlighet med bestämmelserna i inköpsordern.</p>
        </div>
        <p style='margin: 0; padding: 0; color: #213280; font-weight: bold; font-size: 12px; margin-top: 22mm;'>ALLMÄNNA PRINCIPER, VILLKOR</p>
        <p style='margin: 0; padding: 0; font-size: 11px; margin-top: 1mm;'>https://kalstein.eu/p12/Terms-and-Conditions/pages.html</p>
    </div>
    <div class='style-07'><p style='text-align: right; color: #fff; font-size: 9px; margin-right: 12mm; margin-top: 6.5mm; font-weight: bold;'>Sidan [[page_cu]] av [[page_nb]]</p></div>
...
<page backtop="0mm" backbottom="0mm" backleft="0mm" backright="0mm">
    ...
    <div class='logo-05'>
        ...
        <p style='margin: 0; padding: 0; color: #213280; font-size: 9px; margin-top: -2mm; margin-left: 28mm;'>Ett annorlunda tillbehör till din tjänst</p>
    </div>
    <div class='img-loc'>
    ...
    <div class='img-cont'>
        <img src="https://dev.kalstein.plus/plataforma/en/wp-content/plugins/kalsteinCotizacion/assets/images/FAQ_SE.png" style='float: left; width: 100%; height: 100%;'>
    </div>   
    <div class='f-last'>
