...
<div class='cp02'>
    ...
    <div class='h-02'>
        ...
        <div class='h-text-02'>
            ...
            <p class='lt-03'>A Kalstein France, ci occupiamo della piena soddisfazione dei nostri clienti, per questo offriamo servizi a valore aggiunto di massimo livello sulla base della nostra esperienza.</p>
        </div>
    </div>
    <div class='p2img-01'>
    ...
    <div class='cmsj-01'>
        ...
        <div class='i-text'>
            ...
            <p class='i-p'>In qualsiasi parte del mondo, riceverà il suo contributo o la sua formazione dal nostro team di ingegneri specializzato.</p>
        </div>
    </div>
    <div class='cmsj-02'>
        <div class='i'>
        ...
        <div class='i-text'>
            ...
            <p class='i-p'>Il nostro team di lavoro è sempre disponibile a rispondere a tutte le domande e a tutte le domande, in modo da fornire assistenza in qualsiasi situazione.</p>
        </div>
    </div>
    <div class='cmsj-03'>
        <div class='i'>
        ...
        <div class='i-text'>
            ...
            <p class='i-p'>Grazie al suo acquisto, verrà fatta una donazione a una fondazione senza scopo di lucro che combatte il cancro al seno e aiuta le comunità più vulnerabili.</p>
        </div>
    </div>
    <div class='cmsj-04'>
        <div class='i'>
        ...
        <div class='i-text'>
            ...
            <p class='i-p'>Consigli personalizzati per la corretta manutenzione preventiva e correttiva delle apparecchiature, grazie a manuali e articoli di Kalstein, cataloghi speciali ed esercitazioni video.</p>
        </div>
    </div>
    <div class='cmsj-05'>
        <div class='i'>
        ...
        <div class='i-text'>
            ...
            <p class='i-p'>Ci occupiamo di tutta la logistica necessaria per la spedizione dei suoi prodotti, via mare, via terra o via aerea.</p>
        </div>
    </div>
    <div class='cmsj-06'>
        <div class='i'>
        ...
        <div class='i-text'>
            ...
            <p class='i-p'>Con oltre 25 anni di crescita con i nostri clienti, il contenuto moderno e multiformato di Kalstein è ora presente in oltre 10 paesi e sta crescendo.</p>
        </div>
    </div>
    <div class='f2-text'>
        <p class='t-1'>Diritti riservati ® KALSTEIN France S. A. S.,</p>
    </div>
    <div class='style-03'><p style='text-align: right; color: #fff; font-size: 9px; margin-right: 12mm; margin-top: 6.5mm; font-weight: bold;'>Pagina [[page_cu]] di [[page_nb]]</p></div>
...
<page backtop="58mm" backbottom="30mm" backleft="0mm" backright="0mm"> 
    <page_header> 
        <div class='ht'>
            ...
            <div class='tp-02'>
                <p style='font-weight: bold; margin: 0; padding: 0;'>Preventivo N°: <span style='font-weight: lighter;'>QUO<?php echo $id?></span></p>
    ...
    <page_footer> 
        <div class='ft'>
            <div class='ft-01'>
                ...
                <div class='text-ce'>
                    <p style='margin: 0; padding: 0; font-weight: bold; font-size: 12px;'>Marcatura CE: acquistare con la massima tranquillità</p>
                    <p style='margin: 0; padding: 0; font-size: 10px; margin-top: 1mm;'>Tutte le attrezzature di Kalstein sono conformi ai requisiti dell'UE, conformemente ai pertinenti regolamenti.</p>
                </div>
                <div class='img-cora'>
                ...
                <div class='text-cora'>
                    <p style='margin: 0; padding: 0; font-weight: bold; font-size: 12px;'>Con l'acquisizione di un'apparecchiatura Kalstein</p>
                    <p style='margin: 0; padding: 0; font-size: 10px; margin-top: 1mm;'>È possibile contribuire alla Jacinto Convit Foundation, a OneTreePlanted, alla Humatem Foundation e alla Maniapure Foundation.</p>
                </div>
            </div>
            <div class='hr-05'></div>
            <div class='ft-02'>
                ...
                <div class='ftn-3'>
                    <p style='text-align: right; font-size: 9px; margin-top: 6.5mm; font-weight: bold;'>Pagina [[page_cu]] di [[page_nb]]</p>
                </div>
            </div>
        </div>
    </page_footer>
        ...
        <div class='sbt-02'>
            <div class='ob'>
                <div class='sob'>
                    <div class='ob-title'>
                        ...
                        <p style='font-weight: bold; font-size: 12px; margin: 0; padding: 0; text-align: right; margin-top: 2mm;'>Tempi di consegna:</p>
                        <p style='font-weight: bold; font-size: 12px; margin: 0; padding: 0; text-align: right; margin-top: 3mm;'>Rappresentante commerciale:</p>
                        <p style='font-weight: bold; font-size: 12px; margin: 0; padding: 0; text-align: right; margin-top: 12mm;'>Condizioni commerciali:</p>
                    ...
                    <div class='ob-p'>
                        <p style='font-size: 12px; margin: 0; padding: 0; text-align: left; margin-top: 7mm; margin-left: 3mm;'>7 - 10 giorni circa.</p>
                        ...
                        <p style='font-size: 12px; margin: 0; padding: 0; text-align: left; margin-top: 3mm; margin-left: 3mm;'>Anticipo con ordine di acquisto.</p>
            ...
            <div class='totales'>
                <div class='subtotales'>
                    <div class='totales-t'>
                        <p style='font-weight: bold; font-size: 12px; margin: 0; padding: 0; text-align: right;'>Totale parziale:</p>
...
<page backtop="0mm" backbottom="0mm" backleft="0mm" backright="0mm">
    ...
    <div class='main-text'>
        <p style='margin: 0; padding: 0; color: #213280; font-weight: bold; font-size: 12px;'>ACCETTAZIONE DELL'ORDINE DI ACQUISTO</p>
        <div class='i-list'>
        ...
        <div class='i-txt'>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 3mm;'>Kalstein France SAS riceve un ordine di acquisto che esprime fedelmente le condizioni commerciali stabilite nell'offerta.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>Pagamenti in contanti: per l’elaborazione e la spedizione della merce richiesta è richiesta la verifica del pagamento nei conti bancari di Kalstein France.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm; margin-left: 0.2mm;'>Clienti con credito: per la lavorazione e la spedizione della merce richiesta, è richiesta la prova del pagamento nei conti bancari di Kalstein France.</p>
        </div>
        <p style='margin: 0; padding: 0; color: #213280; font-weight: bold; font-size: 12px; margin-top: 10mm;'>VALUTA COMMERCIALE</p>
        <div class='i-list'>
            <p style='text-align: center; margin: 0; padding: 0; margin-top: 3mm;'>•</p>
            <p style='text-align: center; margin: 0; padding: 0; margin-top: 6.5mm;'>•</p>
        </div>
        <div class='i-txt2'>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 0mm;'>Offerte in valuta estera, il calcolo della conversione della valuta sarà effettuato conformemente alle disposizioni della Banca centrale francese, fissate il giorno della fatturazione.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>La valuta di negoziazione stabilita per questa voce è <?php echo $divisa?>.</p>
        </div>
        ...
        <div class='i-txt3'>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 0mm;'>Tutte le attrezzature vendute da Kalstein France hanno una garanzia di un anno a fini di fabbricazione a partire dalla data della fattura delle merci.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>La garanzia non copre i danni causati da un cattivo impianto o funzionamento, da difetti di trasporto o da usi diversi da quelli specificati dal fabbricante.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>La garanzia esclude parti elettriche o di consumo.</p>
        </div>
        <p style='margin: 0; padding: 0; color: #213280; font-weight: bold; font-size: 12px; margin-top: 5mm;'>TEMPI DI CONSEGNA</p>
        <div class='i-list'>
            <p style='text-align: center; margin: 0; padding: 0; margin-top: 3mm;'>•</p>
        </div>
        <div class='i-txt4'>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: -3mm;'>I tempi di consegna indicati nel presente preventivo sono stime soggette a variabili.</p>
        </div>
        <p style='margin: 0; padding: 0; color: #213280; font-weight: bold; font-size: 12px; margin-top: 7mm;'>CANCELLAZIONI E RITORNI SENZA SOLO CAUSA</p>
        <div class='i-list'>
            <p style='text-align: center; margin: 0; padding: 0; margin-top: 3mm;'>•</p>
            <p style='text-align: center; margin: 0; padding: 0; margin-top: 3.5mm;'>•</p>
        ...
        <div class='i-txt5'>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: -3mm;'>Le merci in magazzino avranno una penale pari al 20% del valore dell'ordine di acquisto.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>Dopo aver ricevuto l'ordine di acquisto in modo soddisfacente, l'ordine di acquisto può essere annullato per un massimo di (3) giorni, una volta che non sono state accettate le cancellazioni, e la merce verrà fatturata secondo le modalità stabilite.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>La restituzione della merce sarà di competenza del cliente, la confezione, l'imballaggio e tutte le parti che costituiscono l'attrezzatura da restituire, devono essere in condizioni perfette senza maltrattamenti, graffi ed etichette supplementari, del team del supporto tecnico e logistico di Kalstein France, che redige un rapporto tecnico e indica la ricezione soddisfacente della merce. In caso di mancato ricevimento, le attrezzature saranno fatturate conformemente alle disposizioni dell’ordine di acquisto.</p>
        </div>
        <p style='margin: 0; padding: 0; color: #213280; font-weight: bold; font-size: 12px; margin-top: 22mm;'>POLITICHE, TERMINI E CONDIZIONI GENERALI</p>
        <p style='margin: 0; padding: 0; font-size: 11px; margin-top: 1mm;'>https://kalstein.eu/p12/Terms-and-Conditions/pages.html</p>
    </div>
    <div class='style-07'><p style='text-align: right; color: #fff; font-size: 9px; margin-right: 12mm; margin-top: 6.5mm; font-weight: bold;'>Pagina [[page_cu]] di [[page_nb]]</p></div>
...
<page backtop="0mm" backbottom="0mm" backleft="0mm" backright="0mm">
    ...
    <div class='logo-05'>
        ...
        <p style='margin: 0; padding: 0; color: #213280; font-size: 9px; margin-top: -2mm; margin-left: 28mm;'>Un altro accompagnamento, al suo servizio</p>
    </div>
    <div class='img-loc'>
    ...
    <div class='img-cont'>
        <img src="https://dev.kalstein.plus/plataforma/en/wp-content/plugins/kalsteinCotizacion/assets/images/FAQ_IT.png" style='float: left; width: 100%; height: 100%;'>
    </div>   
    <div class='f-last'>
