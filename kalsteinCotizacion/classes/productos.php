...
<div class='wrap'>
    ...
    <button class="btn btn-primary u-file" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
      Bulk load
    </button>
    ...
    <div class="collapse" id="collapseExample">
      <div class="card card-body bg-secondary bg-opacity-25" style='min-width: 100%;'>
        <div style='min-width: 100%; text-align: center;'>
          ...
          <button style='width: 100%; text-align: center; font-size: 1.5em; margin-top: 2mm;' id='btn-i' class='btn btn-success none'>
            Import
          </button>
        </div>
    ...
    <div class='content-searchBar'>
        <div class="input-group mb-3">
            <input type="text" class="form-control" id='i-searchProducts' placeholder="Search..." aria-label="Recipient's username" aria-describedby="button-addon2">
...
<div class="modal fade" id="updatePrices" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style="z-index : 10000;">
      ...
      <div class="modal-body">
        ...
        <div class="cPercentage none">
          <div class="input-group">
            ...
            <input type="number" id='txt-percentage' class="form-control text-uppercase" aria-label="Username" aria-describedby="basic-addon1">
          </div>
          <br>
          <div class="input-group">
        ...
        <div class="cRate none">
          <div class="input-group">
            ...
            <input type="number" id='txt-rate' class="form-control text-uppercase" aria-label="Username" aria-describedby="basic-addon1">
          </div>
          <br>
          <div class="input-group">
            <span class="input-group-text fw-bold" id="basic-addon1">Categorie:</span>
...
<!-- Modal -->
<div class="modal fade modal-xl" id="addRate" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style="z-index : 10000;">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
        <div class="input-group">
          ...
          <input type="text" id='txt-other-line' class="form-control none" aria-label="Username" aria-describedby="basic-addon1">
          ...
          <input type="text" id='txt-other-category' class="form-control none" aria-label="Username" aria-describedby="basic-addon1">
          ...
          <input type="text" id='txt-other-subcategory' class="form-control none" aria-label="Username" aria-describedby="basic-addon1">
        </div>
        <hr>
        <div class="row">
          <div class="col-8">
            <div class="row">
              <div class="col-4">
                <div class="input-group">
                  ...
                  <input type="text" id='txt-name-product' class="form-control text-uppercase" aria-label="Username" aria-describedby="basic-addon1">
                </div>
              </div>
              <div class="col">
                <div class="input-group">
                  <span class="input-group-text fw-bold" id="basic-addon1">Name:</span>
                  <input type="text" id='txt-name-product' class="form-control" aria-label="Username" aria-describedby="basic-addon1">
                </div>
              </div>
            </div>
            <hr>
            ...
            <div class="input-group">                
              ...
              <input type="number" id='txt-long' class="form-control" aria-label="Username" aria-describedby="basic-addon1">
              <span class="input-group-text fw-bold" id="basic-addon1">Width:</span>
              <input type="number" id='txt-width' class="form-control" aria-label="Username" aria-describedby="basic-addon1">
              <span class="input-group-text fw-bold" id="basic-addon1">Height:</span>
              <input type="number" id='txt-height' class="form-control" aria-label="Username" aria-describedby="basic-addon1">
            </div>
            <hr> 
            <h6 class='fw-bold'>Package Size</h6>
            <div class="input-group">                
              <span class="input-group-text fw-bold" id="basic-addon1">Long:</span>
              <input type="number" id='txt-long1' class="form-control" aria-label="Username" aria-describedby="basic-addon1">
              <span class="input-group-text fw-bold" id="basic-addon1">Width:</span>
              <input type="number" id='txt-width1' class="form-control" aria-label="Username" aria-describedby="basic-addon1">
              <span class="input-group-text fw-bold" id="basic-addon1">Height:</span>
              <input type="number" id='txt-height1' class="form-control" aria-label="Username" aria-describedby="basic-addon1">
            </div> 
          </div>
          <div class="col" style="height: 70mm; padding-right: 3mm; padding-top: 0;">
            <div style="width: 100%; height: 80mm; margin-top: 0;">
              <button class="btn btn-light">
                <img src="http://127.0.0.1/wp-local/wp-content/plugins/kalsteinCotizacion/assets/images/upload_image.png" alt="" style="width: 100%; height: 100%;">
              </button>
            </div>
          </div>
        </div>
          ...
          <div class="col">
            ...
            <div class="input-group">
              <div id="menu-actions1" class="menu-actions">
                <button class="btn b-1" style='height: 9mm; margin-top: 0.5mm; text-align: center;'><i class="fa-sharp fa-solid fa-bold"></i></button>
                <button class="btn i-1" style='height: 9mm; margin-top: 0.5mm; text-align: center;'><i class="fa-sharp fa-solid fa-italic"></i></button>
                <button class="btn" style='height: 9mm; margin-top: 0.5mm; margin-left: 4mm; text-align: center;'><i class="fa-sharp fa-solid fa-list-ol"></i></button>
                <button class="btn" style='height: 9mm; margin-top: 0.5mm; text-align: center;'><i class="fa-sharp fa-solid fa-list-ul"></i></button>
                <button class="btn z-1" style='height: 9mm; margin-top: 0.5mm; margin-left: 4mm; text-align: center;'><i class="fa-sharp fa-solid fa-arrow-rotate-left"></i></button>
                <button class="btn y-1" style="height: 9mm; margin-top: 0.5mm; text-align: center;"><i class="fa-sharp fa-solid fa-arrow-rotate-right"></i></button>
              </div>
          ...
          <div class="col">
            ...
            <div class="input-group">
              <div id="menu-actions2" class="menu-actions">
                <button class="btn" style='height: 9mm; margin-top: 0.5mm; text-align: center;'><i class="fa-sharp fa-solid fa-bold"></i></button>
                <button class="btn" style='height: 9mm; margin-top: 0.5mm; text-align: center;'><i class="fa-sharp fa-solid fa-italic"></i></button>
                <button class="btn" style='height: 9mm; margin-top: 0.5mm; margin-left: 4mm; text-align: center;'><i class="fa-sharp fa-solid fa-list-ol"></i></button>
                <button class="btn" style='height: 9mm; margin-top: 0.5mm; text-align: center;'><i class="fa-sharp fa-solid fa-list-ul"></i></button>
                <button class="btn" style='height: 9mm; margin-top: 0.5mm; margin-left: 4mm; text-align: center;'><i class="fa-sharp fa-solid fa-arrow-rotate-left"></i></button>
                <button class="btn" style="height: 9mm; margin-top: 0.5mm; text-align: center;"><i class="fa-sharp fa-solid fa-arrow-rotate-right"></i></button>
              </div>
...
<div class="modal fade" id="deleteProduct" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Are you sure you want to delete the product <button id='modelDeleteP' style='background: none; border: none; outline: none; font-weight: bold; cursor: text; margin: 0; padding: 0;'></button>?</p>
      </div>
      <div class="modal-footer">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="input-group">
          <span class="input-group-text fw-bold" id="basic-addon1">Model:</span>
          <input type="text" id='txt-modelPE' class="form-control" aria-label="Username" readonly aria-describedby="basic-addon1">
          <span class="input-group-text fw-bold" id="basic-addon1">Name:</span>
        ...
        <div class="input-group">
          ...
          <input type="number" id='txt-grossWE' class="form-control" aria-label="Username" aria-describedby="basic-addon1">
        </div> 
        <hr>
        <h6 class='fw-bold'>Product Size</h6>
        <div class="input-group">                
          <span class="input-group-text fw-bold" id="basic-addon1">Long:</span>
          <input type="number" id='txt-longE' class="form-control" aria-label="Username" aria-describedby="basic-addon1">
          <span class="input-group-text fw-bold" id="basic-addon1">Width:</span>
          <input type="number" id='txt-widthE' class="form-control" aria-label="Username" aria-describedby="basic-addon1">
          <span class="input-group-text fw-bold" id="basic-addon1">Height:</span>
          <input type="number" id='txt-heightE' class="form-control" aria-label="Username" aria-describedby="basic-addon1">
        </div>  
        <hr>
        <h6 class='fw-bold'>Package Size</h6>
        <div class="input-group">                
          <span class="input-group-text fw-bold" id="basic-addon1">Long:</span>
          <input type="number" id='txt-long1E' class="form-control" aria-label="Username" aria-describedby="basic-addon1">
          <span class="input-group-text fw-bold" id="basic-addon1">Width:</span>
          <input type="number" id='txt-width1E' class="form-control" aria-label="Username" aria-describedby="basic-addon1">
          <span class="input-group-text fw-bold" id="basic-addon1">Height:</span>
          <input type="number" id='txt-height1E' class="form-control" aria-label="Username" aria-describedby="basic-addon1">
        </div> 
        <hr>
        <h6 class='fw-bold'>Prices</h6>
        <div class='input-group'>              
          <span class="input-group-text fw-bold" id="basic-addon1">EUR:</span>
          <input type="number" id='txt-pricePE' class="form-control" aria-label="Username" aria-describedby="basic-addon1" min="0" step="0.00">
          <span class="input-group-text fw-bold" id="basic-addon1">USD:</span>
          <input type="number" id='txt-pricePU' class="form-control" aria-label="Username" aria-describedby="basic-addon1" min="0" step="0.00">
        </div>
      </div>
      <div class="modal-footer">
