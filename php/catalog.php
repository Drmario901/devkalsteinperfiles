...
<div class='pagination'>
    ...
    <form id='form-previous-catalog' action='' method='get' style='margin-right: 8px'>
        ...
        <div style='position: relative; display: inline-block;'>
            ...
            <i class='fa-solid fa-arrow-left' style='position: absolute; left: 10px; top: 30%; transform: translateY(-50%); color: black; pointer-events: none;'></i>
        </div>
    </form>
    <form id='form-next-catalog' action='' method='get'>
        ...
        <div style='position: relative; display: inline-block;'>
            <input type='submit' value='' style='color: black !important; border: 1px solid #555 !important; padding-left: 30px;'>
            <i class='fa-solid fa-arrow-right' style='position: absolute; left: 10px; top: 30%; transform: translateY(-50%); color: black; pointer-events: none;'></i>
        </div>
    </form>
</div>
