...
<div class='cp02'>
    ...
    <div class='h-02'>
        ...
        <div class='h-text-02'>
            ...
            <p class='lt-03'>Me hoolitseme Kalstein France'is oma klientide täieliku rahulolu eest, mistõttu pakume oma
                kogemuste põhjal kõrgeima tasemega lisandväärtusega teenuseid.</p>
        </div>
    </div>
    <div class='p2img-01'>
    ...
    <div class='cmsj-01'>
        ...
        <div class='i-text'>
            ...
            <p class='i-p'>Igal pool maailmas, saada oma induktsiooni või koolituse meie spetsialiseeritud meeskond
                insenerid.</p>
        </div>
    </div>
    <div class='cmsj-02'>
        ...
        <div class='i-text'>
            ...
            <p class='i-p'>Meie töömeeskond on alati valmis vastama kõigile teie küsimustele või küsimustele, et aidata
                igal juhul.</p>
        </div>
    </div>
    <div class='cmsj-03'>
        ...
        <div class='i-text'>
            <p class='i-title'>#Letsgivemore <img
                    ...
                    style='width: 12px'></p>
            <p class='i-p'>Tänu ostu, annetuse tehakse mittetulunduslik sihtasutus, mis võitleb rinnavähi ja aitab kõige
                haavatavamad kogukonnad.</p>
        </div>
    </div>
    <div class='cmsj-04'>
        <div class='i'>
        ...
        <div class='i-text'>
            ...
            <p class='i-p'>Tänu Kalsteini käsiraamatutele ja artiklitele, spetsiaalsetele kataloogidele ja
                videoõpetustele saate personaalset nõu oma seadmete õige ennetava ja korrigeeriva hoolduse kohta.</p>
        </div>
    </div>
    <div class='cmsj-05'>
        <div class='i'>
        ...
        <div class='i-text'>
            ...
            <p class='i-p'>Hoolitseme kogu logistika eest, mis on vajalik teie toodete transportimiseks, olgu need siis
                mere-, maa- või õhuteed pidi.</p>
        </div>
    </div>
    <div class='cmsj-06'>
        <div class='i'>
        ...
        <div class='i-text'>
            ...
            <p class='i-p'>Üle 25 aasta kasvab meie klientidega, Kalstein kaasaegne, multi-formaadis sisu on nüüd olemas
                üle 10 riigis ja kasvab.</p>
        </div>
    </div>
    <div class='f2-text'>
...
<page backtop="58mm" backbottom="30mm" backleft="0mm" backright="0mm">
    <page_header>
        <div class='ht'>
            ...
            <div class='tp-02'>
                <p style='font-weight: bold; margin: 0; padding: 0;'>Tsitaat N°: <span
    ...
    <page_footer>
        <div class='ft'>
            <div class='ft-01'>
                ...
                <div class='text-ce'>
                    <p style='margin: 0; padding: 0; font-weight: bold; font-size: 12px;'>CE-märgis: osta meelerahuga
                    </p>
                    <p style='margin: 0; padding: 0; font-size: 10px; margin-top: 1mm;'>Kõik Kalsteini seadmed vastavad
                        Euroopa Liidu nõuetele vastavalt asjakohastele eeskirjadele.</p>
                </div>
                <div class='img-cora'>
                    <img src="https://dev.kalstein.plus/plataforma/en/wp-content/plugins/kalsteinPerfiles/kalsteinCotizacion/assets/images/icono3.png"
                ...
                <div class='text-cora'>
                    <p style='margin: 0; padding: 0; font-weight: bold; font-size: 12px;'>Kalsteini seadmete
                        omandamisega</p>
                    <p style='margin: 0; padding: 0; font-size: 10px; margin-top: 1mm;'>Te teete panuse Jacinto Convit
                        Foundation, OneTreeImplanteeritud, Humatem Foundation ja Maniapure Foundation.</p>
                </div>
            </div>
            <div class='hr-05'></div>
            <div class='ft-02'>
                ...
                <div class='ftn-3'>
                    <p style='text-align: right; font-size: 9px; margin-top: 6.5mm; font-weight: bold;'>Leht [[page_cu]]
                        või [[page_nb]]</p>
                </div>
            </div>
        </div>
...
<page backtop="0mm" backbottom="0mm" backleft="0mm" backright="0mm">
    ...
    <div class='main-text'>
        <p style='margin: 0; padding: 0; color: #213280; font-weight: bold; font-size: 12px;'>OSTUTELLIMUSE
            AKTSEPTEERIMINE</p>
        <div class='i-list'>
        ...
        <div class='i-txt'>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 3mm;'>Kalstein France SAS
                saab ostutellimuse rahuldamise, kui see dokument väljendab tõeselt pakkumises kehtestatud
                kaubandustingimusi.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>Sularahamaksed:
                Soovitud kauba töötlemiseks ja lähetamiseks on nõutav makse kontrollimine Kalstein France'i
                pangakontodel.</p>
            <p
                style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm; margin-left: 0.2mm;'>
                Kliendid, kellel on Credit: Töötlemise ja saatmise nõutud kaup, maksetõend Kalstein Prantsusmaa
                pangakontod on nõutav.</p>
        </div>
        ...
        <div class='i-txt2'>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: -3mm;'>Pakkumised
                välisvaluutas, valuuta konverteerimise arvutamine toimub vastavalt sätetele Bank of France, kehtestatud
                päeval arve.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>Kehtestatud
                kauplemise valuuta see loetelu on <?php echo $divisa ?>.</p>
        </div>
        <p style='margin: 0; padding: 0; color: #213280; font-weight: bold; font-size: 12px; margin-top: 5mm;'>GARANTII
        </p>
        <div class='i-list'>
            <p style='text-align: center; margin: 0; padding: 0; margin-top: 3mm;'>•</p>
        ...
        <div class='i-txt3'>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: -6mm;'>Kõik seadmed, mida
                Kalstein France müüb, on alates kaubaarve kuupäevast üheaastase garantii tootmise eesmärgil.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>Garantii ei kata
                kahju, mille on põhjustanud halb paigaldus või kasutus, veopuudused või muud kui tootja poolt ette
                nähtud kasutusviisid.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>Garantii ei hõlma
                elektrilisi või tarbitavaid osi.</p>
        </div>
        <p style='margin: 0; padding: 0; color: #213280; font-weight: bold; font-size: 12px; margin-top: 5mm;'>TARNEAJAD
        </p>
        <div class='i-list'>
            <p style='text-align: center; margin: 0; padding: 0; margin-top: 2mm;'>•</p>
        </div>
        <div class='i-txt4'>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: -13mm;'>Selles pakkumises
                märgitud tarneajad on hinnangud, mille suhtes kohaldatakse muutujaid.</p>
        </div>
        <p style='margin: 0; padding: 0; color: #213280; font-weight: bold; font-size: 12px; margin-top: 7mm;'>
            TÜHISTAMISED JA TAGASTAMISED ILMA PÕHJUSETA</p>
        <div class='i-list'>
            <p style='text-align: center; margin: 0; padding: 0; margin-top: 3mm;'>•</p>
            <p style='text-align: center; margin: 0; padding: 0; margin-top: 3mm;'>•</p>
        ...
        <div class='i-txt5'>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: -13mm;'>Varudes olevate
                kaupade puhul määratakse trahv, mis võrdub 20% ostutellimuse väärtusest.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>Kaupade importimine
                on pärast ostutellimuse nõuetekohast kättesaamist maksimaalselt (3) päeva ostutellimuse tühistamiseks,
                pärast seda kui tühistamisi ei aktsepteerita ja kaup arveldatakse nii, nagu kehtestatud.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>Kauba tagastamise
                eest vastutab Klient, kasti, pakendi ja kõik osad, mis moodustavad tagastatava varustuse, peab olema
                ideaalses seisukorras ilma väärkohtlemise, kriimustuste ja lisamärgised, Kalstein Prantsusmaa Tehniline
                Tugi ja Logistika meeskond, kes teostab tehnilise aruande ja näitab rahuldavat kättesaamist kaup. Kui
                see ei ole saadud rahuldavalt, seadmed arveldatakse vastavalt sätetele ostutellimuse.</p>
        </div>
        <p style='margin: 0; padding: 0; color: #213280; font-weight: bold; font-size: 12px; margin-top: 22mm;'>ÜLDISED
            PÕHIMÕTTED, TINGIMUSED</p>
...
<page backtop="0mm" backbottom="0mm" backleft="0mm" backright="0mm">
    ...
    <div class='logo-05'>
        ...
        <p style='margin: 0; padding: 0; color: #213280; font-size: 9px; margin-top: -2mm; margin-left: 28mm;'>Teie
            teenistuses on teistsugune saade</p>
    </div>
    <div class='img-loc'>
    ...
    <div class='img-cont'>
        <img src="https://dev.kalstein.plus/plataforma/en/wp-content/plugins/kalsteinPerfiles/kalsteinCotizacion/assets/images/FAQ_EE.png"
