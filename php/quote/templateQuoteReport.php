...
<div class='cp01'>
    <div class='h-01'>
        <img src="https://dev.kalstein.plus/plataforma/wp-content/plugins/kalsteinCotizacion/assets/images/francia-pais.jpg" style='float: right; width: 18%; margin-top: 25mm; margin-right: 45mm;'>
    </div>
    <div class='b-01' style='background-image: url(https://dev.kalstein.plus/plataforma/wp-content/plugins/kalsteinCotizacion/assets/images/fondo.png)'>
        <div class='id'>
            <div class='logo'>
                <img src="https://dev.kalstein.plus/plataforma/wp-content/plugins/kalsteinCotizacion/assets/images/logo.png" style='float: right; width: 70%; margin-top: 55mm; margin-right: 2%;'>
            </div>
            <div class='hr'></div>
            <div class='n-id'>
                <p class='co'>QUOTE</p>
        ...
        <div class='f-01'>
            <div class='qr'>
                <img src="https://dev.kalstein.plus/plataforma/wp-content/plugins/kalsteinCotizacion/assets/images/qr.jpg" style='width: 100%;'>
            </div>
            <div class='f-text'>
            ...
            <div class='hr-2'></div>
            <div class='img-logo2'>
            <img src="https://dev.kalstein.plus/plataforma/wp-content/plugins/kalsteinCotizacion/assets/images/logo-blanco.png" style='width: 50%; float: right;'>
            </div>
        </div>       
    </div>    
</div>
<page backtop="58mm" backbottom="30mm" backleft="0mm" backright="0mm"> 
    <page_header> 
        <div class='ht'>
            <div class='logo-03'>
                <img src="https://dev.kalstein.plus/plataforma/wp-content/plugins/kalsteinCotizacion/assets/images/logo.png" style='float: right; width: 70%; margin-top: 15mm; margin-right: 2mm;'>
            </div>
            <div class='tp-01'>
                <p>KALSTEIN FRANCE SIREN: 819 970 815</p>
            </div>
            <div class='tp-02'>
                <p style='font-weight: bold; margin: 0; padding: 0;'>Cotización N°: <span style='font-weight: lighter;'>QUO<?php echo $idCotizacion?></span></p>
    ...
    <page_footer> 
        <div class='ft'>
            <div class='ft-01'>
                <div class='img-ce'>
                    <img src="https://dev.kalstein.plus/plataforma/wp-content/plugins/kalsteinCotizacion/assets/images/img-ce.jpg" style='float: right; width: 100%; margin-top: 5mm;'>
                </div>
                <div class='text-ce'>
                ...
                <div class='img-cora'>
                    <img src="https://dev.kalstein.plus/plataforma/wp-content/plugins/kalsteinCotizacion/assets/images/icono3.png" style='float: right; width: 90%; margin-top: 7mm;'>
                </div>
                <div class='text-cora'>
        ...
        <div class='sbt-02'>
            ...
            <div class='totales'>
                <div class='subtotales'>
                    ...
                    <div class='totales-n'>
                        <p style='font-size: 12px; margin: 0; padding: 0; text-align: right; margin-left: 3mm;'><?php echo $subtotal?>.00  <?php echo " " . $divisa ?></p>  
                        <p style='font-size: 12px; margin: 0; padding: 0; text-align: right; margin-top: 2mm; margin-left: 3mm;'>0.00 <?php echo " " . $divisa ?></p>                
                        <p style='font-size: 12px; margin: 0; padding: 0; text-align: right; margin-top: 2mm; margin-left: 3mm;'><?php echo $total . " " . $divisa?></p>
                    </div>
                </div>
            </div>
        </div>
