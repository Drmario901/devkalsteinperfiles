...
$imagen01 = 'https://platform.kalstein.us/wp-content/plugins/kalsteinPerfiles/kalsteinCotizacion/assets/images/francia-pais.jpg'; /* 557x534 */
/* $imagen02 = 'https://platform.kalstein.us/wp-content/plugins/kalsteinPerfiles/kalsteinCotizacion/assets/images/fondo.png' */
$imagen03 = 'https://dev.kalstein.plus/plataforma/wp-content/plugins/kalsteinPerfiles/kalsteinCotizacion/assets/images/LogoActualizado2.png'; /* 1581x421 */
$imagen04 = 'https://platform.kalstein.us/wp-content/plugins/kalsteinPerfiles/kalsteinCotizacion/assets/images/qr.jpg'; /* 238x238 */
$imagen05 = 'https://dev.kalstein.plus/plataforma/wp-content/plugins/kalsteinPerfiles/kalsteinCotizacion/assets/images/k+blanco.png';
$imagen06 = 'https://platform.kalstein.us/wp-content/plugins/kalsteinPerfiles/kalsteinCotizacion/assets/images/imagen1.jpg';
$imagen07 = 'https://dev.kalstein.plus/plataforma/wp-content/plugins/kalsteinPerfiles/kalsteinCotizacion/assets/images/img2p.png';
$imagen08 = 'https://dev.kalstein.plus/plataforma/wp-content/plugins/kalsteinPerfiles/kalsteinCotizacion/assets/images/img1p.png';
$imagen09 = 'https://platform.kalstein.us/wp-content/plugins/kalsteinPerfiles/kalsteinCotizacion/assets/images/icono1.png';
$imagen10 = 'https://platform.kalstein.us/wp-content/plugins/kalsteinPerfiles/kalsteinCotizacion/assets/images/icono2.png';
$imagen11 = 'https://platform.kalstein.us/wp-content/plugins/kalsteinPerfiles/kalsteinCotizacion/assets/images/icono3.png';
$imagen12 = 'https://platform.kalstein.us/wp-content/plugins/kalsteinPerfiles/kalsteinCotizacion/assets/images/icono4.png';
$imagen13 = 'https://platform.kalstein.us/wp-content/plugins/kalsteinPerfiles/kalsteinCotizacion/assets/images/icono5.png';
$imagen14 = 'https://platform.kalstein.us/wp-content/plugins/kalsteinPerfiles/kalsteinCotizacion/assets/images/icono6.png';
$imagen15 = 'https://platform.kalstein.us/wp-content/plugins/kalsteinPerfiles/kalsteinCotizacion/assets/images/corazon.png';
$imagen16 = 'https://platform.kalstein.us/wp-content/plugins/kalsteinPerfiles/kalsteinCotizacion/assets/images/img-ce.jpg';
$imagen17 = 'https://platform.kalstein.us/wp-content/plugins/kalsteinPerfiles/kalsteinCotizacion/assets/images/imagen4.jpg';
$imagen18 = 'https://platform.kalstein.us/wp-content/plugins/kalsteinPerfiles/kalsteinCotizacion/assets/images/FAQ_ES.png';
...
<div class="htmlTemplate">
    ...
    <link rel="stylesheet" type="text/css"
        href="https://dev.kalstein.plus/plataforma/wp-content/plugins/kalsteinPerfiles/kalsteinCotizacion/classes/pdfletter.css">
    <!-- pagina 01 -->
    <div class='cp01' style="position: relative;">
        <div class="emailAccValue" id="emailAccValue" data-email="<?php echo $emailAcc; ?>" style="display: none;">
        </div>
        <div class="cNameValue" id="cNameValue" data-name="<?php echo $cName; ?>" style="display: none;"></div>
        <div id="backgroundCp01">
        </div>
        <div class='h-01'>
            <img src="<?php echo $imagen01 ?>" style='position:absolute; width: 18%; top: 25mm; right: 25mm;'
                id="p1Img01">
        </div>
        <div class='b-01'>
            <div class='id'>
                <div class='logo'>
                    <img src="<?php echo $imagen03 ?>"
                        style='width: 287.86px; height: 84.72px; position:absolute; top:158.2mm' id='p1Img02'>
                </div>
                <div class='hr'></div>
            ...
            <div class='f-01'>
                ...
                <div class='f-text'>
                    <p class='l-1 my-0 p1FooterP' id='p1FooterP1'>Todos los derechos reservados ® KALSTEIN France S. A.
                        S.</p>
    ...
    <div class='cp02' style='display: none; position: relative;'>
        <page backtop="58mm" backbottom="30mm" backleft="0mm" backright="0mm">
            <page_header>
                <div class='ht'>
                    <div class='logo-03'>
                        <img src="<?php echo $imagen03 ?>" style='width: 249px !important; height: 73px !important;'
                            id='logoP2'>
                    </div>
                    <div class='tp-01'>
                    ...
                    <div class='tp-02'>
                        ...
                        <p style='margin: 0; padding: 0; margin-top: -1mm;'>Paris, <?php echo $onlyDate ?>
                            <?php echo $onlyHours ?></p>
                    </div>
                </div>
                <div class='hr-04'></div>
                <div class='cliente'>
                    <div class='sres'>
                        ...
                        <p style='margin: 0; padding: 0; margin-top: 1mm; margin-top: -2mm; font-size: 13px;'>
                            <?php echo $sres ?><!-- kalstein --></p>
                    </div>
                    <div class='atc'>
                        <p style='margin: 0; padding: 0; font-weight: bold; margin-top: 2mm;'>Atención:</p>
                        <p style='margin: 0; padding: 0; margin-top: 1mm; margin-top: -2mm; font-size: 13px;'>
                            <?php echo $atc ?><!-- Alejandro Espidea --></p>
                    </div>
                </div>
            ...
            <page_footer>
                <div class='ft'>
                    <div class='ft-01'>
                        ...
                        <div class='text-ce'>
                            <p style='margin: 0; padding: 0; font-weight: bold; font-size: 12px; margin-bottom: -5px;'
                                class="p2P1" id='p2F1P1'>Marcado CE: para comprar con tranquilidad</p>
                            <p style='margin: 0; padding: 0; font-size: 10px; margin-top: 1mm; line-height: 1;'
                                class="p2P2" id='p2F1P2'>Todos los equipos Kalstein cumplen los requisitos de la UE, de
                                acuerdo con la normativa pertinente.</p>
                        </div>
                        <div class='img-cora'>
                            <img src="<?php echo $imagen11 ?>"
                                style='float: right; width: 51.02px; height: 49.48px; margin-top: -5mm;' id="p2Img03">
                        </div>
                        <div class='text-cora'>
                            <p style='margin: 0; padding: 0; font-weight: bold; font-size: 12px; margin-bottom: -5px;'
                                class="p2P3" id='p2F1P3'>Con la adquisición de un equipo Kalstein</p>
                            <p style='margin: 0; padding: 0; font-size: 10px; margin-top: 1mm; width: 284px; line-height: 1;'
                                class="p2P4" id='p2F1P4'>Realizas una aportación a la Fundación Jacinto Convit,
                                OneTreePlanted, Fundación Humatem y Fundación Maniapure.</p>
                        </div>
                    </div>
                    <div class='hr-05'></div>
                    <div class='ft-02'>
                        <div class='ft-02-text'>
                            <p style='margin: 0; padding: 0; font-size: 9px; margin-top: 5mm;' class="p2P5" id='p2F2P1'>
                                KALSTEIN FRANCE S.A.S</p>
                            <p style='margin: 0; padding: 0; font-size: 9px; margin-top: -0.5mm;' class="p2P6"
                                id='p2F2P2'>• 2 Rue Jean Lantier, • 75001 Paris •</p>
                            <p style='margin: 0; padding: 0; font-size: 8px;' class="p2P7" id='p2F2P3'>+33 1 78 95 87 89
                                / +33 6 80 76 07 10 • https://kalstein.eu</p>
                        </div>
                        <div class='ftn-3'>
                    ...
                    <div class='sbt-02'>
                        <div class='ob'>
                            <div class='sob'>
                                ...
                                <div class='ob-p'>
                                    <p id="p2BillP"
                                        style='font-size: 12px; margin: 0; padding: 0; text-align: left; margin-top: 7.5mm; margin-left: 3mm;'>
                                        <?php echo $deliveryTime ?></p>
                                    <p
                                        style='font-size: 12px; margin: 0; padding: 0; text-align: left; margin-top: -0.5mm; margin-left: 3mm;'>
                                        Correo: sales.department@dev.kalstein.plus/plataforma</p>
                                    <p
                                    ...
                                    <p
                                        style='font-size: 12px; margin: 0; padding: 0; text-align: left; margin-top: -0.7mm; margin-left: 3mm;'>
                        ...
                        <div class='totales'>
                            <div class='subtotales'>
                                <div class='totales-t'>
                                    <p
                                        style='font-weight: bold; font-size: 12px; margin: 0; padding: 0; text-align: right;'>
                                        Subtotal:</p>
                                    <?php
                                    echo $txtDiscount;
                                    echo $txtSubTotalC;
                                ...
                                <div class='totales-n'>
                                    <p
                                        style='font-size: 12px; margin: 0; padding: 0; text-align: right; margin-left: 3mm;'>
                                        <?php echo $subtotal ?><!-- vdp --><!-- 4531.88 --></p>
                                    <?php
                                    echo $numDiscount;
                                    echo $subtotalC
                                        ?>
                                    ...
                                    <p
                                        style='font-size: 12px; margin: 0; padding: 0; text-align: right; margin-top: 0mm; margin-left: 3mm;'>
                                        <?php echo $envio ?><!-- vdp --><!-- 1154.30 --></p>
                                    <?php
                                    echo $numArancel;
                                    echo $numIva;
                                    ?>
    ...
    <div class='cp03' style='display: none; position: relative;'>
        <page backtop="0mm" backbottom="0mm" backleft="0mm" backright="0mm">
            ...
            <div class='h4-02'>
                <div class='logo4-02'>
                    <img src="<?php echo $imagen03 ?>" style='float: right; width: 241.88px; height: 71.19px;'
                        id='logoP3'>
                </div>
        ...
        <img src="<?php echo $imagen06 ?>" style='float: right; width: 100%;'>
            ...
            <div class='main-text'>
                <p style='margin: 0; padding: 0; color: #213280; font-weight: bold; font-size: 11px; text-wrap: nowrap;'
                    class="subtitle4" id='p3PSID'>ACEPTACIÓN DE LA ORDEN DE COMPRA</p>
                <div class='i-list'>
                ...
                <div class='i-txt'>
                    <p class='p3P'
                        style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 4mm;'>Kalstein
                        France SAS recibe una orden de compra a satisfacción, cuando este documento expresa fielmente
                        las condiciones comerciales establecidas en la oferta.</p>
                    <p class='p3P'
                        style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 2mm;'>Pagos en
                        efectivo: Para la tramitación y envío de la mercancía solicitada, se requiere la verificación
                        del pago en las cuentas bancarias de Kalstein France.</p>
                    <p class='p3P'
                        style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1.7mm; margin-left: 0.2mm;'>
                        Clientes con crédito: Para la tramitación y envío de la mercancía solicitada se requiere el
                        justificante de pago en cuentas bancarias de Kalstein France.</p>
                </div>
                <p style='margin: 0; padding: 0; color: #213280; font-weight: bold; font-size: 11px; margin-top: 5mm;'
                    class="subtitle4">NEGOCIACIÓN DE DIVISAS</p>
                <div class='i-list'>
                ...
                <div class='i-txt2'>
                    <p class='p3P'
                        style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 10mm;'>Ofertas
                        en moneda extranjera, el cálculo de conversión de divisas se realizará de acuerdo con las
                        disposiciones del Banco de Francia, fijado en el día de la facturación.</p>
                    <p class='p3P'
                        style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 2mm;'>La moneda
                        de negociación establecida para esta cotización es <?php echo $divisa ?>.</p>
                </div>
                <p style='margin: 0; padding: 0; color: #213280; font-weight: bold; font-size: 11px; margin-top: -14mm;'
                    class="subtitle4">GARANTÍA</p>
                <div class='i-list'>
                    <p class='p3P' style='text-align: center; margin: 0; padding: 0; margin-top: 3mm;'>•</p>
                ...
                <div class='i-txt3'>
                    <p class='p3P'
                        style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 0mm;'>Todos los
                        equipos vendidos por Kalstein Francia tienen una garantía de un año a efectos de fabricación a
                        partir de la fecha de facturación de la mercancía.</p>
                    <p class='p3P'
                        style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>La
                        garantía no cubre los daños causados por una mala instalación o funcionamiento, defectos de
                        transporte o por usos distintos de los especificados por el fabricante.</p>
                    <p class='p3P'
                        style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>La
                        garantía excluye las piezas eléctricas o consumibles.</p>
                </div>
                <p style='margin: 0; padding: 0; color: #213280; font-weight: bold; font-size: 11px; margin-top: -3mm;'
                    class="subtitle4">TIEMPOS DE ENTREGA</p>
                <div class='i-list'>
                    <p class='p3P' style='text-align: center; margin: 0; padding: 0; margin-top: 4mm;'>•</p>
                </div>
                <div class='i-txt4'>
                    <p class='p3P'
                        style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 0mm;'>Los plazos
                        de entrega indicados en este presupuesto son estimaciones sujetas a variables.</p>
                </div>
                <p style='margin: 0; padding: 0; color: #213280; font-weight: bold; font-size: 11px; margin-top: -26mm;'
                    class="subtitle4">ANULACIONES Y DEVOLUCIONES SIN CAUSA JUSTIFICADA</p>
                <div class='i-list'>
                    <p class='p3P' style='text-align: center; margin: 0; padding: 0; margin-top: 3mm;'>•</p>
                ...
                <div class='i-txt5'>
                    <p class='p3P'
                        style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 3mm;'>La
                        mercancía en existencias tendrá una penalización equivalente al 20% del valor de la orden de
                        compra.</p>
                    <p class='p3P'
                        style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>Mercancía
                        de Importación, después de recibir la orden de compra a satisfacción, hay un máximo de (3) días
                        para cancelar la orden de compra, después de este tiempo no se aceptan cancelaciones y la
                        mercancía se facturará según lo establecido.</p>
                    <p class='p3P'
                        style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>La
                        devolución de la mercancía será responsabilidad del Cliente, la caja, embalaje y todas las
                        partes que componen el equipo a devolver, deberán estar en perfecto estado sin maltratos,
                        arañazos y etiquetas adicionales, el equipo de Soporte Técnico y Logística de Kalstein Francia,
                        realizará informe técnico e indicará la recepción satisfactoria de la mercancía. En caso de no
                        ser recibida satisfactoriamente, el equipo será facturado de acuerdo con lo establecido en la
                        Orden de Compra.</p>
                </div>
                <p style='margin: 0; padding: 0; color: #213280; font-weight: bold; font-size: 11px; margin-top: 22mm;'
                    class="subtitle4">POLÍTICAS, TÉRMINOS Y CONDICIONES GENERALES</p>
                <p class="i-txt6 p3P" style='margin: 0; padding: 0; font-size: 11px; margin-top: 0mm;'>
