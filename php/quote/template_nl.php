...
<div class='cp02'>
    ...
    <div class='h-02'>
        ...
        <div class='h-text-02'>
            ...
            <p class='lt-03'>Bij Kalstein France zorgen we voor de volledige tevredenheid van onze klanten, daarom
                bieden we op basis van onze ervaring diensten met toegevoegde waarde van het hoogste niveau.</p>
        </div>
    </div>
    <div class='p2img-01'>
    ...
    <div class='cmsj-01'>
        ...
        <div class='i-text'>
            ...
            <p class='i-p'>Ontvang in elk deel van de wereld uw introductie of training van ons gespecialiseerde team
                van ingenieurs.</p>
        </div>
    </div>
    <div class='cmsj-02'>
        ...
        <div class='i-text'>
            ...
            <p class='i-p'>Ons werkteam is altijd beschikbaar om al uw vragen of vragen te beantwoorden, om in elke
                situatie te helpen.</p>
        </div>
    </div>
    <div class='cmsj-03'>
        <div class='i'>
        ...
        <div class='i-text'>
            <p class='i-title'>#Letsgivemore <img
                    ...
                    style='width: 12px'></p>
            <p class='i-p'>Dankzij uw aankoop wordt een donatie gedaan aan een non-profit stichting die borstkanker
                bestrijdt en de meest kwetsbare gemeenschappen helpt.</p>
        </div>
    </div>
    <div class='cmsj-04'>
        <div class='i'>
        ...
        <div class='i-text'>
            ...
            <p class='i-p'>Geniet van gepersonaliseerd advies voor het juiste preventieve en correctieve onderhoud van
                uw apparatuur, dankzij Kalstein handleidingen en artikelen, speciale catalogi en video tutorials.</p>
        </div>
    </div>
    <div class='cmsj-05'>
        <div class='i'>
        ...
        <div class='i-text'>
            ...
            <p class='i-p'>Wij zorgen voor alle logistiek die nodig is voor de verzending van uw producten, zowel over
                zee, over land als door de lucht.</p>
        </div>
    </div>
    <div class='cmsj-06'>
        <div class='i'>
        ...
        <div class='i-text'>
            ...
            <p class='i-p'>Met meer dan 25 jaar groei bij onze klanten, is Kalstein's moderne, multi-format content nu
                aanwezig in meer dan 10 landen en groeit.</p>
        </div>
    </div>
    <div class='f2-text'>
...
<page backtop="58mm" backbottom="30mm" backleft="0mm" backright="0mm">
    <page_header>
        <div class='ht'>
            ...
            <div class='tp-02'>
                <p style='font-weight: bold; margin: 0; padding: 0;'>Citaat N°: <span
    ...
    <page_footer>
        <div class='ft'>
            <div class='ft-01'>
                ...
                <div class='text-ce'>
                    <p style='margin: 0; padding: 0; font-weight: bold; font-size: 12px;'>CE-markering: kopen met een
                        gerust hart</p>
                    <p style='margin: 0; padding: 0; font-size: 10px; margin-top: 1mm;'>Alle Kalstein apparatuur voldoet
                        aan de eisen van de EU, in overeenstemming met de relevante regelgeving.</p>
                </div>
                <div class='img-cora'>
                    <img src="https://dev.kalstein.plus/plataforma/en/wp-content/plugins/kalsteinPerfiles/kalsteinCotizacion/assets/images/icono3.png"
                ...
                <div class='text-cora'>
                    <p style='margin: 0; padding: 0; font-weight: bold; font-size: 12px;'>Met de aankoop van een
                        Kalstein uitrusting</p>
                    <p style='margin: 0; padding: 0; font-size: 10px; margin-top: 1mm;'>Je levert een bijdrage aan de
                        Jacinto Convit Foundation, OneTreePlanted, Humatem Foundation en de Maniapure Foundation.</p>
                </div>
            </div>
            <div class='hr-05'></div>
            <div class='ft-02'>
            ...
            <div class='ob'>
                <div class='sob'>
                    ...
                    <div class='ob-p'>
                        ...
                        <p
                            style='font-size: 12px; margin: 0; padding: 0; text-align: left; margin-top: 3mm; margin-left: 3mm;'>
                            Vooruitbetaling met kooporder.</p>
                        <p
                            style='font-size: 12px; margin: 0; padding: 0; text-align: left; margin-top: 1mm; margin-left: 3mm;'>
...
<page backtop="0mm" backbottom="0mm" backleft="0mm" backright="0mm">
    ...
    <div class='main-text'>
        <p style='margin: 0; padding: 0; color: #213280; font-weight: bold; font-size: 12px;'>ACCEPTATIE VAN
            INKOOPORDERS</p>
        <div class='i-list'>
        ...
        <div class='i-txt'>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 3mm;'>Kalstein France SAS
                ontvangt een voldoening van de kooporder wanneer dit document een getrouwe weergave is van de
                commerciële voorwaarden die in het aanbod zijn vastgelegd.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>Contante
                betalingen: Voor de verwerking en verzending van de gevraagde goederen is verificatie van de betaling op
                Kalstein France bankrekeningen vereist.</p>
            <p
                style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm; margin-left: 0.2mm;'>
                Klanten met Credit: Voor de verwerking en verzending van de gevraagde merchandise is een bewijs van
                betaling in Kalstein France bankrekeningen vereist.</p>
        </div>
        ...
        <div class='i-txt2'>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 3mm;'>Aanbiedingen in
                vreemde valuta, de valutaomrekening zal worden uitgevoerd in overeenstemming met de bepalingen van de
                Bank van Frankrijk, vastgesteld op de dag van facturering.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>De gangbare
                handelsvaluta voor deze aanbieding is <?php echo $divisa ?>.</p>
        </div>
        ...
        <div class='i-txt3'>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 3mm;'>Alle door Kalstein
                France verkochte apparatuur heeft vanaf de factuurdatum van de goederen een jaar garantie voor
                fabricagedoeleinden.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>De garantie dekt
                geen schade veroorzaakt door slechte installatie of werking, transportgebreken of door andere gebruiken
                dan door de fabrikant opgegeven.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>De garantie omvat
                geen elektrische of verbruiksonderdelen.</p>
        </div>
        ...
        <div class='i-txt4'>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 3mm;'>De levertijden die
                in deze offerte worden vermeld, zijn schattingen afhankelijk van variabelen.</p>
        </div>
        <p style='margin: 0; padding: 0; color: #213280; font-weight: bold; font-size: 12px; margin-top: 7mm;'>
            ANNULERINGEN EN RETOUREN ZONDER RECHTVAARDIGE REDEN</p>
        <div class='i-list'>
            <p style='text-align: center; margin: 0; padding: 0; margin-top: 3mm;'>•</p>
        ...
        <div class='i-txt5'>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 3mm;'>Goederen in
                voorraad hebben een boete gelijk aan 20% van de waarde van de kooporder.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>Import Merchandise,
                na ontvangst van de kooporder tot tevredenheid, is er een maximum van (3) dagen om de kooporder te
                annuleren, nadat deze tijd annuleringen niet worden geaccepteerd en de merchandise zal worden
                gefactureerd zoals vastgesteld.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>De terugzending van
                de goederen zal de verantwoordelijkheid zijn van de Klant, de doos, verpakking en alle onderdelen
                waaruit de te retourneren apparatuur bestaat, moet in perfecte staat zijn zonder mishandeling, krassen
                en extra etiketten, het team van Kalstein France Technical Support and Logistics, dat technisch rapport
                uitvoert en zal aangeven dat de goederen naar behoren zijn ontvangen. Als de apparatuur niet op
                bevredigende wijze wordt ontvangen, wordt de apparatuur gefactureerd in overeenstemming met de
                bepalingen van de inkooporder.</p>
        </div>
        <p style='margin: 0; padding: 0; color: #213280; font-weight: bold; font-size: 12px; margin-top: 22mm;'>ALGEMENE
            BELEIDSLIJNEN, VOORWAARDEN EN BEPALINGEN</p>
...
<page backtop="0mm" backbottom="0mm" backleft="0mm" backright="0mm">
    ...
    <div class='logo-05'>
        ...
        <p style='margin: 0; padding: 0; color: #213280; font-size: 9px; margin-top: -2mm; margin-left: 28mm;'>Een
            andere begeleiding, tot uw dienst</p>
    </div>
    <div class='img-loc'>
    ...
    <div class='img-cont'>
        <img src="https://dev.kalstein.plus/plataforma/en/wp-content/plugins/kalsteinPerfiles/kalsteinCotizacion/assets/images/FAQ_NL.png"
