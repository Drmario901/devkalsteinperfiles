...
<div class='wrap'>
    ...
    <button type="button" id="updateRate" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#confirmUpdateRate">
    Update
    </button>
    <input type="number" class="i-rateU" id="i-rateU" placeholder="% increase in Air shipment"/>
    <input type="number" class="i-rateU" id="i-rateUM" placeholder="% increase in Sea freight"/>
    <br><hr>
...
<!-- Modal -->
<div class="modal fade" id="confirmUpdateRate" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title fw-bold" id="exampleModalLabel">Confirm Update</h5>
        <button type="button" class="btn-close" id='ur-cancel' data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <span>Are you sure to apply this rate of increase to the rates?</span>
      </div>
      <div class="modal-footer">
        <button type="button" id='ur-cancel' class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
        <button type="button" class="btn btn-success" id='saveUpdateRate'>Save</button>
      </div>
    </div>
  </div>
</div>