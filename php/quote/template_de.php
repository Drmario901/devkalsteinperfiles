...
<div class='cp02'>
    ...
    <div class='h-02'>
        ...
        <div class='h-text-02'>
            ...
            <p class='lt-03'>Bei Kalstein Frankreich kümmern wir uns um die volle Zufriedenheit unserer Kunden, deshalb bieten wir Mehrwertdienste auf höchstem Niveau basierend auf unserer Erfahrung.</p>
        </div>
    </div>
    <div class='p2img-01'>
    ...
    <div class='cmsj-01'>
        ...
        <div class='i-text'>
            ...
            <p class='i-p'>In jedem Teil der Welt, erhalten Sie Ihre Einführung oder Ausbildung von unserem spezialisierten Team von Ingenieuren.</p>
        </div>
    </div>
    <div class='cmsj-02'>
        <div class='i'>
        ...
        <div class='i-text'>
            ...
            <p class='i-p'>Unser Team steht Ihnen jederzeit zur Verfügung, um Ihre Fragen zu beantworten, um Ihnen in jeder Situation zu helfen.</p>
        </div>
    </div>
    <div class='cmsj-03'>
        <div class='i'>
        ...
        <div class='i-text'>
            ...
            <p class='i-p'>Dank Ihres Kaufs erhalten Sie eine Spende an eine gemeinnützige Stiftung, die Brustkrebs bekämpft und den am stärksten gefährdeten Gemeinschaften hilft.</p>
        </div>
    </div>
    <div class='cmsj-04'>
        <div class='i'>
        ...
        <div class='i-text'>
            ...
            <p class='i-p'>Genießen Sie mit Kalstein Handbüchern und Artikeln, speziellen Katalogen und Video-Tutorials eine persönliche Beratung zur korrekten präventiven und korrektiven Wartung Ihrer Geräte.</p>
        </div>
    </div>
    <div class='cmsj-05'>
        <div class='i'>
        ...
        <div class='i-text'>
            ...
            <p class='i-p'>Wir kümmern uns um die gesamte Logistik, die für den Versand Ihrer Produkte erforderlich ist, sei es auf dem See-, Land- oder Luftweg.</p>
        </div>
    </div>
    <div class='cmsj-06'>
        <div class='i'>
        ...
        <div class='i-text'>
            ...
            <p class='i-p'>Mit über 25 Jahren Wachstum bei unseren Kunden sind die modernen, multiformatigen Inhalte von Kalstein nun in über 10 Ländern präsent und wachsen weiter.</p>
        </div>
    </div>
    <div class='f2-text'>
        <p class='t-1'>Alle Rechte vorbehalten ® KALSTEIN France S. A. S.,</p>
    </div>
    <div class='style-03'><p style='text-align: right; color: #fff; font-size: 9px; margin-right: 12mm; margin-top: 6.5mm; font-weight: bold;'>Seite [[page_cu]] von [[page_nb]]</p></div>
    ...
    <page_footer> 
        <div class='ft'>
            <div class='ft-01'>
                ...
                <div class='text-ce'>
                    <p style='margin: 0; padding: 0; font-weight: bold; font-size: 12px;'>CE-Kennzeichnung: sorgenfrei kaufen</p>
                    <p style='margin: 0; padding: 0; font-size: 10px; margin-top: 1mm;'>Die gesamte Ausrüstung von Kalstein entspricht den Anforderungen der EU gemäß den einschlägigen Vorschriften.</p>
                </div>
                <div class='img-cora'>
                ...
                <div class='text-cora'>
                    <p style='margin: 0; padding: 0; font-weight: bold; font-size: 12px;'>Mit der Anschaffung einer Kalstein Ausrüstung</p>
                    <p style='margin: 0; padding: 0; font-size: 10px; margin-top: 1mm;'>Sie leisten einen Beitrag für die Jacinto Convit Foundation, OneTreePlanted, Humatem Foundation und die Maniapure Foundation.</p>
                </div>
            </div>
            <div class='hr-05'></div>
            <div class='ft-02'>
                ...
                <div class='ftn-3'>
                    <p style='text-align: right; font-size: 9px; margin-top: 6.5mm; font-weight: bold;'>Seite [[page_cu]] von [[page_nb]]</p>
                </div>
            </div>
        </div>
    </page_footer>
        ...
        <div class='sbt-02'>
            <div class='ob'>
                <div class='sob'>
                    <div class='ob-title'>
                        ...
                        <p style='font-weight: bold; font-size: 12px; margin: 0; padding: 0; text-align: right; margin-top: 2mm;'>Lieferzeiten:</p>
                        <p style='font-weight: bold; font-size: 12px; margin: 0; padding: 0; text-align: right; margin-top: 3mm;'>Handelsvertreter:</p>
                        <p style='font-weight: bold; font-size: 12px; margin: 0; padding: 0; text-align: right; margin-top: 11.8mm;'>Handelsbedingungen:</p>
                    ...
                    <div class='ob-p'>
                        <p style='font-size: 12px; margin: 0; padding: 0; text-align: left; margin-top: 7mm; margin-left: 3mm;'>7 - 10 Tage ca.</p>
                        ...
                        <p style='font-size: 12px; margin: 0; padding: 0; text-align: left; margin-top: 3mm; margin-left: 3mm;'>Vorauszahlung mit Bestellung.</p>
            ...
            <div class='totales'>
                <div class='subtotales'>
                    <div class='totales-t'>
                        <p style='font-weight: bold; font-size: 12px; margin: 0; padding: 0; text-align: right;'>Zwischensumme:</p>
...
<page backtop="0mm" backbottom="0mm" backleft="0mm" backright="0mm">
    ...
    <div class='main-text'>
        ...
        <div class='i-txt'>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 3mm;'>Kalstein France SAS erhält eine Zufriedenheit mit der Bestellung, wenn dieses Dokument die im Angebot festgelegten Geschäftsbedingungen getreu wiedergibt.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>Barzahlungen: Für die Bearbeitung und den Versand der angeforderten Ware ist eine Überprüfung der Zahlung auf Kalstein France Bankkonten erforderlich.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm; margin-left: 0.2mm;'>Kunden mit Guthaben: Für die Bearbeitung und den Versand der angeforderten Ware ist ein Zahlungsnachweis in Kalstein France-Bankkonten erforderlich.</p>
        </div>
        <p style='margin: 0; padding: 0; color: #213280; font-weight: bold; font-size: 12px; margin-top: 10mm;'>HANDELSWÄHRUNG</p>
        <div class='i-list'>
            <p style='text-align: center; margin: 0; padding: 0; margin-top: 3mm;'>•</p>
            <p style='text-align: center; margin: 0; padding: 0; margin-top: 6mm;'>•</p>
        </div>
        <div class='i-txt2'>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 3mm;'>Bei Angeboten in Fremdwährung erfolgt die Währungsumrechnung nach den am Tag der Rechnungsstellung geltenden Bestimmungen der Bank of France.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>Die etablierte Handelswährung für diesen Eintrag ist <?php echo $divisa?>.</p>
        </div>
        <p style='margin: 0; padding: 0; color: #213280; font-weight: bold; font-size: 12px; margin-top: 5mm;'>GEWÄHRLEISTUNG</p>
        <div class='i-list'>
        ...
        <div class='i-txt3'>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 3mm;'>Für alle von Kalstein France verkauften Geräte gilt eine einjährige Garantie für Herstellungszwecke ab dem Rechnungsdatum der Ware.
</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>Die Garantie erstreckt sich nicht auf Schäden, die durch unsachgemäße Installation oder Bedienung, Transportfehler oder durch andere als die vom Hersteller angegebenen Verwendungen verursacht wurden.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>Die Garantie schließt elektrische oder Verbrauchsmaterialien aus.</p>
        </div>
        <p style='margin: 0; padding: 0; color: #213280; font-weight: bold; font-size: 12px; margin-top: 5mm;'>LIEFERZEITEN</p>
        <div class='i-list'>
            <p style='text-align: center; margin: 0; padding: 0; margin-top: 6.5mm;'>•</p>
        </div>
        <div class='i-txt4'>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 3mm;'>Die in diesem Angebot angegebenen Lieferzeiten sind Schätzungen, die von Variablen abhängig sind.</p>
        </div>
        <p style='margin: 0; padding: 0; color: #213280; font-weight: bold; font-size: 12px; margin-top: 7mm;'>STORNIERUNGEN UND RÜCKSENDUNGEN OHNE BEGRÜNDUNG</p>
        <div class='i-list'>
        ...
        <div class='i-txt5'>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 3mm;'>Die Ware im Lager wird eine Strafe in Höhe von 20% des Wertes der Bestellung haben.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>Importieren Sie Waren, nachdem Sie die Bestellung zur Zufriedenheit erhalten haben, gibt es maximal (3) Tage, um die Bestellung zu stornieren, nachdem diese Zeit Stornierungen nicht akzeptiert werden und die Waren wie festgelegt in Rechnung gestellt werden.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>Die Rücksendung der Ware obliegt dem Kunden, die Box, Verpackung und alle Teile, aus denen die zurückzusendende Ausrüstung besteht, müssen in einwandfreiem Zustand ohne Misshandlung, Kratzer und zusätzliche Etiketten sein, das technische Support- und Logistikteam von Kalstein France führt den technischen Bericht durch und zeigt den zufriedenstellenden Empfang der Ware an. Wenn es nicht zufriedenstellend empfangen wird, wird das Gerät gemäß den Bestimmungen der Bestellung in Rechnung gestellt.</p>
        </div>
        <p style='margin: 0; padding: 0; color: #213280; font-weight: bold; font-size: 12px; margin-top: 22mm;'>ALLGEMEINE RICHTLINIEN, GESCHÄFTSBEDINGUNGEN</p>
        <p style='margin: 0; padding: 0; font-size: 11px; margin-top: 1mm;'>https://kalstein.eu/p12/Terms-and-Conditions/pages.html</p>
    </div>
    <div class='style-07'><p style='text-align: right; color: #fff; font-size: 9px; margin-right: 12mm; margin-top: 6.5mm; font-weight: bold;'>Seite [[page_cu]] von [[page_nb]]</p></div>
...
<page backtop="0mm" backbottom="0mm" backleft="0mm" backright="0mm">
    ...
    <div class='logo-05'>
        ...
        <p style='margin: 0; padding: 0; color: #213280; font-size: 9px; margin-top: -2mm; margin-left: 28mm;'>Eine andere Begleitung, zu Ihren Diensten</p>
    </div>
    <div class='img-loc'>
    ...
    <div class='img-cont'>
        <img src="https://dev.kalstein.plus/plataforma/en/wp-content/plugins/kalsteinCotizacion/assets/images/FAQ_DE.png" style='float: left; width: 100%; height: 100%;'>
    </div>   
    <div class='f-last'>
