...
<div class='cp02'>
    ...
    <div class='h-02'>
        ...
        <div class='h-text-02'>
            ...
            <p class='lt-03'>Chez Kalstein France, nous nous occupons de la pleine satisfaction de nos clients, c'est
                pourquoi nous fournissons des services à valeur ajoutée de haut niveau sur la base de notre expérience.
            </p>
        </div>
    </div>
    <div class='p2img-01'>
    ...
    <div class='cmsj-01'>
        ...
        <div class='i-text'>
            ...
            <p class='i-p'>Dans n'importe quelle partie du monde, recevez votre initiation ou formation de notre équipe
                spécialisée d'ingénieurs.</p>
        </div>
    </div>
    <div class='cmsj-02'>
        <div class='i'>
        ...
        <div class='i-text'>
            ...
            <p class='i-p'>Notre équipe de travail est toujours disponible pour répondre à toutes vos questions, afin de
                vous aider dans toutes les situations.</p>
        </div>
    </div>
    <div class='cmsj-03'>
        <div class='i'>
        ...
        <div class='i-text'>
            <p class='i-title'>#Letsgivemore <img
                    ...
                    style='width: 12px'></p>
            <p class='i-p'>Grâce à votre achat, un don sera fait à une fondation à but non lucratif qui lutte contre le
                cancer du sein et aide les communautés les plus vulnérables.</p>
        </div>
    </div>
    <div class='cmsj-04'>
        <div class='i'>
        ...
        <div class='i-text'>
            ...
            <p class='i-p'>Profitez de conseils personnalisés pour la maintenance préventive et corrective de votre
                équipement, grâce aux manuels et articles Kalstein, aux catalogues spéciaux et aux tutoriels vidéo.</p>
        </div>
    </div>
    <div class='cmsj-05'>
        <div class='i'>
        ...
        <div class='i-text'>
            ...
            <p class='i-p'>Nous nous occupons de toute la logistique nécessaire à l'expédition de vos produits, que ce
                soit par voie maritime, terrestre ou aérienne.</p>
        </div>
    </div>
    <div class='cmsj-06'>
        <div class='i'>
        ...
        <div class='i-text'>
            ...
            <p class='i-p'>Avec plus de 25 ans de croissance avec nos clients, le contenu moderne et multiformat de
                Kalstein est maintenant présent dans plus de 10 pays et en pleine croissance.</p>
        </div>
    </div>
    <div class='f2-text'>
...
<page backtop="58mm" backbottom="30mm" backleft="0mm" backright="0mm">
    <page_header>
        <div class='ht'>
            ...
            <div class='tp-02'>
                <p style='font-weight: bold; margin: 0; padding: 0;'>Devis N°: <span
    ...
    <page_footer>
        <div class='ft'>
            <div class='ft-01'>
                ...
                <div class='text-ce'>
                    <p style='margin: 0; padding: 0; font-weight: bold; font-size: 12px;'>Marquage CE : acheter en toute
                        tranquillité d'esprit</p>
                    <p style='margin: 0; padding: 0; font-size: 10px; margin-top: 1mm;'>Tous les équipements Kalstein
                        sont conformes aux exigences de l'UE, conformément à la réglementation applicable.</p>
                </div>
                <div class='img-cora'>
                    <img src="https://dev.kalstein.plus/plataforma/en/wp-content/plugins/kalsteinPerfiles/kalsteinCotizacion/assets/images/icono3.png"
                ...
                <div class='text-cora'>
                    <p style='margin: 0; padding: 0; font-weight: bold; font-size: 12px;'>Avec l'acquisition d'un
                        équipement Kalstein</p>
                    <p style='margin: 0; padding: 0; font-size: 10px; margin-top: 1mm;'>Vous contribuez à la Fondation
                        Jacinto Convit, OneTreePlanted, la Fondation Humatem et la Fondation Maniapure.</p>
                </div>
            </div>
            <div class='hr-05'></div>
            <div class='ft-02'>
            ...
            <div class='ob'>
                <div class='sob'>
                    ...
                    <div class='ob-p'>
                        ...
                        <p
                            style='font-size: 12px; margin: 0; padding: 0; text-align: left; margin-top: 3mm; margin-left: 3mm;'>
                            Acompte avec bon de commande.</p>
                        <p
                            style='font-size: 12px; margin: 0; padding: 0; text-align: left; margin-top: 1mm; margin-left: 3mm;'>
...
<page backtop="0mm" backbottom="0mm" backleft="0mm" backright="0mm">
    ...
    <div class='main-text'>
        <p style='margin: 0; padding: 0; color: #213280; font-weight: bold; font-size: 12px;'>ACCEPTATION DE COMMANDE
            FOURNISSEUR</p>
        <div class='i-list'>
        ...
        <div class='i-txt'>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 3mm;'>Kalstein France SAS
                reçoit une satisfaction de bon de commande, lorsque ce document exprime fidèlement les conditions
                commerciales établies dans l'offre.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>Paiements en
                espèces : Pour le traitement et l'expédition de la marchandise demandée, la vérification du paiement sur
                les comptes bancaires Kalstein France est requise.</p>
            <p
                style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm; margin-left: 0.2mm;'>
                Clients avec crédit : Pour le traitement et l'expédition de la marchandise demandée, une preuve de
                paiement sur les comptes bancaires Kalstein France est requise.</p>
        </div>
        <p style='margin: 0; padding: 0; color: #213280; font-weight: bold; font-size: 12px; margin-top: 10mm;'>DEVISE
            DE TRANSACTION</p>
        <div class='i-list'>
            <p style='text-align: center; margin: 0; padding: 0; margin-top: 3mm;'>•</p>
        ...
        <div class='i-txt2'>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 3mm;'>Offres en devises
                étrangères, le calcul de la conversion monétaire sera effectué conformément aux dispositions de la
                Banque de France, fixées le jour de la facturation.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>La devise de
                négociation établie pour cette annonce est <?php echo $divisa ?>.</p>
        </div>
        <p style='margin: 0; padding: 0; color: #213280; font-weight: bold; font-size: 12px; margin-top: 5mm;'>GARANTIE
        </p>
        <div class='i-list'>
            <p style='text-align: center; margin: 0; padding: 0; margin-top: 3mm;'>•</p>
            <p style='text-align: center; margin: 0; padding: 0; margin-top: 6.5mm;'>•</p>
        ...
        <div class='i-txt3'>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 3mm;'>Tous les
                équipements vendus par Kalstein France bénéficient d'une garantie d'un an à des fins de fabrication à
                compter de la date de facturation des marchandises.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>La garantie ne
                couvre pas les dommages causés par une mauvaise installation ou un mauvais fonctionnement, des défauts
                de transport ou par des utilisations autres que celles spécifiées par le fabricant.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>La garantie exclut
                les pièces électriques ou consommables.</p>
        </div>
        <p style='margin: 0; padding: 0; color: #213280; font-weight: bold; font-size: 12px; margin-top: 5mm;'>DÉLAIS DE
            LIVRAISON</p>
        <div class='i-list'>
            <p style='text-align: center; margin: 0; padding: 0; margin-top: 3mm;'>•</p>
        </div>
        <div class='i-txt4'>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 3mm;'>Les délais de
                livraison indiqués dans ce devis sont des estimations sujettes à variables.</p>
        </div>
        <p style='margin: 0; padding: 0; color: #213280; font-weight: bold; font-size: 12px; margin-top: 7mm;'>
            ANNULATIONS ET RETOURS SANS JUSTIFICATION</p>
        <div class='i-list'>
            <p style='text-align: center; margin: 0; padding: 0; margin-top: 3mm;'>•</p>
        ...
        <div class='i-txt5'>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 3mm;'>Les marchandises en
                stock auront une pénalité équivalente à 20 % de la valeur du bon de commande.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>Importer la
                marchandise, après réception de la commande à la satisfaction, il y a un maximum de (3) jours pour
                annuler la commande, après cette période les annulations ne sont pas acceptées et la marchandise sera
                facturée comme établi.</p>
            <p style='margin: 0; padding: 0; font-size: 11px; text-align: justify; margin-top: 1mm;'>Le retour de la
                marchandise sera à la charge du Client, de la caisse, de l'emballage et de toutes les pièces composant
                l'équipement à renvoyer, doit être en parfait état sans mauvais traitement, rayures et étiquettes
                supplémentaires, l'équipe d'assistance technique et logistique de Kalstein France, réalisant le rapport
                technique et indiquera la réception satisfaisante de la marchandise. S'il n'est pas reçu de manière
                satisfaisante, l'équipement sera facturé conformément aux dispositions du Bon de Commande.</p>
        </div>
        <p style='margin: 0; padding: 0; color: #213280; font-weight: bold; font-size: 12px; margin-top: 22mm;'>
            POLITIQUES GÉNÉRALES, CONDITIONS GÉNÉRALES</p>
...
<page backtop="0mm" backbottom="0mm" backleft="0mm" backright="0mm">
    ...
    <div class='logo-05'>
        ...
        <p style='margin: 0; padding: 0; color: #213280; font-size: 9px; margin-top: -2mm; margin-left: 28mm;'>Un
            accompagnement différent, à votre service</p>
    </div>
    <div class='img-loc'>
    ...
    <div class='img-cont'>
        <img src="https://dev.kalstein.plus/plataforma/en/wp-content/plugins/kalsteinPerfiles/kalsteinCotizacion/assets/images/FAQ_FR.png"
