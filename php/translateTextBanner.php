...
function translateTextBanner($translationss = $translations, $banner) {
    // Include the translations file
    $language = isset($_COOKIE['language']) ? $_COOKIE['language'] : 'en';
            // Determinar el texto del banner según el idioma
            $banner_text_translation = isset($translationss[$language][$banner]) ? $translationss[$language][$banner] : $translationss['en'][$banner];
