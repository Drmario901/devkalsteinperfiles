<?php
    ...
    $consulta2 = "SELECT * FROM wp_account WHERE account_rol_aid = '1' ORDER BY account_aid DESC";   
        ...
        <table class='table custom-table'>
            <thead class='headTableForQuote'>
                <tr>
                    ...
                    <td data-i17n='client:fechaTable'>Fecha</td>
                </tr>
            </thead>
        ...
        while ($value = $resultado2->fetch_assoc()) {
            ...
            if ($count3 > 0){
                if ($statusQuote == 0 || $statusQuote == 1){
                    $html.= "                                    
                        <tr class='rowAccount' email='$email'>
                            <td>$email</td>
                            <td>$name</td>
                            <td>$lastname</td>
                            <td>$pais</td>
