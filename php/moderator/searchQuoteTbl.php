<?php
    ...
    if ($resultado->num_rows > 0){
        ...
        while ($value = $resultado->fetch_assoc()) {
            ...
            <div class='d-flex flex-row justify-content-evenly mt-2'>
                <button type='button' id='btnProcess' class='btn btn-info btn-block p-2' value='$id'>Process</button>
                <button type='button' id='btnDeny' class='btn btn-danger btn-block p-2' value='$id'>Deny</button>
            </div>" : '';
                ...
                <tr>
                    ...
                    <td>
                        <div class='d-flex flex-row align-items-center justify-content-around'>                        
                            <button type='button' id='btnInfoClientQuote' style='color: #444 !important; font-size: 16px;' data-bs-toggle='modal' data-bs-target='#exampleModal' value='$id' title='Ver información del cliente'><i class='fa-solid fa-address-book'></i></button>
                            <button type='button' class='fa-solid fa-eye btn-details' style='color: #444 !important; font-size: 16px;' value='$id' title='Ver cotización'></button>
                            <a href='https://plataforma.kalstein.net/wp-content/plugins/kalsteinCotizacion/classes/createPDF.php?idCotizacion=$id' target='__blank' style='color: green' title='Ver PDF'>
                                <i class='fa-solid fa-up-right-from-square'></i>
                            </a>
                            <button type='button' id='btnDonwloadInfoClientQuote' style='color: #444 !important; font-size: 16px;' value='$id' title='Descargar'><i class='fa-solid fa-download'></i></button>
                        </div>
                    </td>
    ...
    $html .= "
        ...
        <div id='currentPageIndicator' style='margin-bottom:10px;'>Page: 1</div>
            <form id='form-previous' action='' method='get'>
