...
$query_processed_orders = "SELECT COUNT(*) FROM wp_cotizacion WHERE cotizacion_status = 'Processed' AND cotizacion_id_remitente = '$email'";
...
$query_pending_orders = "SELECT COUNT(*) FROM wp_cotizacion WHERE cotizacion_status = 'Process' AND cotizacion_id_remitente = '$email'";
...
FROM wp_cotizacion
WHERE cotizacion_status = 'Processed' AND cotizacion_create_at >= '$before_6_month' AND cotizacion_id_remitente = '$email'";
$query5_1 = "SELECT SUM(wp_cotizacion.cotizacion_total) AS total_sum
FROM wp_cotizacion
WHERE cotizacion_status = 'Processed' AND cotizacion_create_at >= '$before_5_month' AND cotizacion_id_remitente = '$email'";
$query4_1 = "SELECT SUM(wp_cotizacion.cotizacion_total) AS total_sum
FROM wp_cotizacion
WHERE cotizacion_status = 'Processed' AND cotizacion_create_at >= '$before_4_month' AND cotizacion_id_remitente = '$email'";
$query3_1 = "SELECT SUM(wp_cotizacion.cotizacion_total) AS total_sum
FROM wp_cotizacion
WHERE cotizacion_status = 'Processed' AND cotizacion_create_at >= '$before_3_month' AND cotizacion_id_remitente = '$email'";
$query2_1 = "SELECT SUM(wp_cotizacion.cotizacion_total) AS total_sum
FROM wp_cotizacion
WHERE cotizacion_status = 'Processed' AND cotizacion_create_at >= '$before_2_month' AND cotizacion_id_remitente = '$email'";
$query1_1 = "SELECT SUM(wp_cotizacion.cotizacion_total) AS total_sum
FROM wp_cotizacion
WHERE cotizacion_status = 'Processed' AND cotizacion_create_at >= '$before_1_month' AND cotizacion_id_remitente = '$email'";
...
WHERE wp_cotizacion.cotizacion_status = 'Processed' AND wp_cotizacion.cotizacion_create_at >= '$before_6_month' AND wp_cotizacion.cotizacion_id_remitente = '$email'
