...
function perfiles_styles()
{
    ...
    $plugin_quote = 'https://dev.kalstein.plus/plataforma/wp-content/plugins/kalsteinPerfiles/kalsteinCotizacion';
    ...
    if (is_a($post, 'WP_Post') && has_shortcode($post->post_content, 'SUPORT_PURSACHING')) {
        ...
        wp_enqueue_script('bootstrap-JS', plugins_url('src/bootstrap/js/bootstrap.bundle.min.js', __FILE__), array('jquery'));
        wp_enqueue_script('nav', plugins_url('src/manufacturer/js/nav.js', __FILE__), array('jquery'));
        wp_enqueue_script('quote-script-js', 'https://dev.kalstein.plus/plataforma/wp-content/plugins/kalsteinPerfiles/kalsteinCotizacion/assets/js/script.cot2.js', array('jquery'), true);
        wp_enqueue_style('quote-css', 'https://dev.kalstein.plus/plataforma/wp-content/plugins/kalsteinPerfiles/kalsteinCotizacion/assets/css/styles.cot.css', true);
        wp_enqueue_script('JS', plugins_url('src/js/dashboard.script.js', __FILE__), array('jquery'));
        wp_enqueue_script('acordeon', plugins_url('src/js/acordeon.js', __FILE__), array('jquery'));
        wp_enqueue_script('pursaching-script', plugins_url('src/distributor/js/pursaching.js', __FILE__), array('jquery'));
        wp_enqueue_style('AlertJS-CSS', plugins_url('jAlert-master/dist/jAlert.css', __FILE__));
...
/*
    ...
    Plugin Name: Kalstein - Cotización

    Description:  Plugin desarrollado para la generación de cotizaciones automaticas de Kalstein
...
function createdMenu()
{
    add_menu_page(
        ...
        plugin_dir_path(__FILE__) . 'kalsteinCotizacion/kalsteinCotizacion/classes/cotizacion.php', //Slug
        null,//Contenido
        plugin_dir_url(__FILE__) . 'kalsteinCotizacion/kalsteinCotizacion/assets/images/icon.png',//Icono
        '4' //Priority
    );

    add_submenu_page(
        plugin_dir_path(__FILE__) . 'kalsteinCotizacion/classes/cotizacion.php', //Slug Parents
        'Rates', //Título
        'Rates', //Título del submenu
        'manage_options', //Capability
        plugin_dir_path(__FILE__) . 'kalsteinCotizacion/classes/tarifas.php' //Slug
    );
    ...
    add_submenu_page(
        ...
        'manage_options', //Capability
        plugin_dir_path(__FILE__) . 'kalsteinCotizacion/classes/productos.php' //Slug
    );
...
function bootstrapJS($hook)
{
    ...
    wp_enqueue_script('bootstrapJS', plugins_url('kalsteinCotizacion/assets/bootstrap/js/bootstrap.min.js', __FILE__), array('jquery'));
}
...
function JS($hook)
{
    ...
    wp_enqueue_script('JS', plugins_url('kalsteinCotizacion/assets/js/script.js', __FILE__), array('jquery'));
}
...
function jQueryCookie($hook)
{
    ...
    wp_enqueue_script('jQueryCookie', plugins_url('kalsteinCotizacion/assets/js/jquery.cookie.js', __FILE__), array('jquery'));
}
...
function bootstrapCSS($hook)
{
    ...
    wp_enqueue_style('bootstrapCSS', plugins_url('kalsteinCotizacion/assets/bootstrap/css/bootstrap.min.css', __FILE__));
}
...
function CSS($hook)
{
    ...
    wp_enqueue_style('CSS', plugins_url('kalsteinCotizacion/assets/css/style.css', __FILE__));
}
...
function my_shortcode_styles()
{
    ...
    if (is_a($post, 'WP_Post') && has_shortcode($post->post_content, 'NAVBAR_KALSTEIN')) {
        wp_enqueue_style('boostrap-css', plugins_url('kalsteinCotizacion/assets/bootstrap/css/bootstrap.min.css', __FILE__));
        wp_enqueue_script('boostrap-JS', plugins_url('kalsteinCotizacion/assets/bootstrap/js/bootstrap.bundle.min.js', __FILE__), array('jquery'));
    }

    if (is_a($post, 'WP_Post') && has_shortcode($post->post_content, 'COTIZACION_KALSTEIN')) {
        wp_enqueue_style('shortcode-css', plugins_url('kalsteinCotizacion/assets/css/styles.cot.css', __FILE__));
        wp_enqueue_script('script-Quote', plugins_url('kalsteinCotizacion/assets/js/script.cot2.js', __FILE__), array('jquery'));
    }

    if (is_a($post, 'WP_Post') && has_shortcode($post->post_content, 'LOGIN_KALSTEIN')) {
        wp_enqueue_style('shortcode-css', plugins_url('kalsteinCotizacion/assets/css/styles.cot.css', __FILE__));
        wp_enqueue_script('JS', plugins_url('kalsteinCotizacion/assets/js/script.cot2.js', __FILE__), array('jquery'));
    }
