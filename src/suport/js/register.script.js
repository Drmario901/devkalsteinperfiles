jQuery(document).ready(function ($) {
  ...
  function savedInformationClientN(
    nameB,
    countryB,
    stateB,
    addressB,
    ...
    $.ajax({
      url: "https://dev.kalstein.plus/plataforma/wp-content/plugins/kalsteinPerfiles/php/savedInfoClient.php",
      type: "POST",
      data: {
        nameB,
        countryB,
  ...
  function savedInformationsoporte(
    nameB,
    countryB,
    stateB,
    addressB,
    ...
    $.ajax({
      ...
      .done(function (respuesta) {
        ...
        if (data.update === "correcto") {
          $(location).attr(
            "href",
            "http://dev.kalstein.plus/wp-local/suport/home"
          );
        } else {
          console.log("error");
        }
