...
jQuery(document).ready(function ($) {
  ...
  function updateFormData(
    ...
    $.ajax({
      url: "https://https://dev.kalstein.plus/plataforma/wp-content/plugins/kalsteinPerfiles/php/suport/service-update.php",
      type: "POST",
      data: {
        actualizar_id,
        SE_servicio,
      ...
      .done(function (response) {
        ...
        if (response.status === "Correcto") {
          ...
          window.location.href =
            "https://https://dev.kalstein.plus/plataforma/index.php/support/services";
        } else {
          iziToast.error({
            title: "Erreur",
...
jQuery(document).ready(function ($) {
  $(document).on("click", "#btn-service-details", function () {
    ...
    $.ajax({
      url: "https://https://dev.kalstein.plus/plataforma/wp-content/plugins/kalsteinPerfiles/php/suport/serviceinfo.php",
      method: "POST",
      data: { service_id },
    }).done(function (response) {
...
jQuery(document).ready(function ($) {
  ...
  function category(consulta) {
    $.ajax({
      url: "https://https://dev.kalstein.plus/plataforma/wp-content/plugins/kalsteinPerfiles/php/suport/category_product.php",
      type: "POST",
      data: { consulta },
    })
      .done(function (respuesta) {
...
jQuery(document).ready(function ($) {
  $(document).on("click", "#btnEditService", function () {
    ...
    let form = $(
      "<form action='https://https://dev.kalstein.plus/plataforma/index.php/support/services/edit/' method='get' hidden>" +
...
jQuery(document).ready(function ($) {
  ...
  function searchCountry(consulta) {
    $.ajax({
      url: "https://https://dev.kalstein.plus/plataforma/wp-content/plugins/kalsteinPerfiles/php/suport/pais.php",
      type: "POST",
      data: { consulta },
    })
      .done(function (respuesta) {
      ...
      buttons: [
        [
          ...
          function (instance, toast) {
            ...
            $.ajax({
              url: "https://https://dev.kalstein.plus/plataforma/wp-content/plugins/kalsteinPerfiles/php/suport/delete-service.php",
              type: "POST",
              data: { delete_aid },
            })
              .done(function (response) {
