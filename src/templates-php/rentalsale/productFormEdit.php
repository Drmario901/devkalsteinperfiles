<?php
    if ($add){
        ...
        <div class='form-group mb-3 col-12'>
            <label data-i18n='rentalsale:labelUnitsToSellOrRent'>Units to sell or rent</label>
...
<form method="post" class="tm-edit-product-form">
    <div class="row">
        ...
        <?php echo $add ? '<div class="col-12"><div class="stock-title" data-i18n="rentalsale:addNewProduct">Add new product</div></div>' : '<div class="col-12"><div class="stock-title" data-i18n="rentalsale:editProduct">Edit product</div></div>'?>
        <!-- BASIC DATA -->
        <div class="col-12 col-md-6">
            ...
            <input style="color: #000 !important;" id="brandProduct" type="text" class="form-control validate" data-placeholder="placeholderBrand" placeholder="Brand"/>
            ...
            <label data-i18n="labelCondition">Condition</label>
            <select id="productCondition">
                <option value="" data-i18n="elementSelectDos">-- Select --</option>
                <option value="New" data-i18n="elementNew">New</option>
                <option value="Like new" data-i18n="elementLikeNew">Like new</option>
                <option value="Very good" data-i18n="elementVeryGood">Very good</option>
                <option value="good" data-i18n="elementGood">Good</option>
                <option value="Acceptable" data-i18n="elementAcceptable">Acceptable</option> 
            </select>
        ...
        <div class="col-12 mb-4">
            <label data-i18n="labelDescription">Description</label>
    ...
    <div class="row">
        <div class="form-group mb-3 col-sm-6 col-xsm-12">
            <label data-i18n="rentalsale:labelUnitPrice">Unit price</label>
            <input
                id="priceProduct"
                type="number"
                step="0.01"
