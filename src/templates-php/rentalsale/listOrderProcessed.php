...
<nav class="nav nav-borders">
    ...
    <a class="nav-link active" href="https://testing.kalstein.digital/index.php/rentalsale/list-order/processed" data-i18n="rentalsale:linkProcessedOrder">Processed orders</a>
...
<div id="listOrderTable" class="table-responsive">
    <?php
        ...
        $consulta = "SELECT * FROM wp_cotizacion WHERE cotizacion_status = 'Processed' AND cotizacion_id_remitente = '$email' LIMIT $offset, $limit";
