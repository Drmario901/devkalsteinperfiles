...
<main>
    <article class="container article">
        ...
        <div class="row">
            ...
            WHERE gd.guide_detail_number = 1 AND g.guide_status_id = 2;            
            ";
                    ...
                    echo "
                            <div class='col-lg-6'>
                                <div class='card row m-2'>
                                    ...
                                    <p class='mt-2 mb-1' style='font-size: 1.15em'><i class='fa-solid fa-user'></i> <b>Published by:</b> $guideMaker</p>
                                    <div class='col-12'>
                                        <a href='https://dev.kalstein.plus/plataforma/index.php/moderator/view-guide?guideId=$guideId'>
