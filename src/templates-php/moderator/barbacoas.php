        ...
        <div class="row">
            ...
            <div class='col-lg-6'>
                <div class='card row m-2'>
                    ...
                    <p class='mt-2 mb-1' style='font-size: 1.15em'><i class='fa-solid fa-user'></i> <b>Published by:</b>
                        user@mail.com</p>
                    <div class='col-12'>
                    ...
                    <div class='mt-2'>
                        <div class='fw-bold card'
                            ...
                            <p class='m-0 p-0' style=><i class='fa-regular fa-circle-check'></i> Verifying by:
                                mod@mail.com</p>
                        </div>
