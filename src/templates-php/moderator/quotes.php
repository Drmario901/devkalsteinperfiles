    ...
    <article class="container article">
        ...
        <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-xl-2">
                    <button type='button' style='color: #444; font-size: 16px; border: 2px solid #444; border-radius: 5px; padding: 10px 20px;' id='btnGenerateCSV' class='btnGenerateCSV' data-bs-toggle='modal' data-bs-target='#filtroModal'>Export <i class="fa-solid fa-file-csv"></i></button>
                </div>
            </div>
            <div class='row'>
                <div class='col-xl-2'>
