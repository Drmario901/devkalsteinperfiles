                ...
                if ($result->num_rows > 0){
                    while ($row = $result->fetch_assoc()){
                        ...
                        if ($resultAction->num_rows > 0){
                            ...
                            $verifying_by = "
                            <div class='fw-bold card' style='border: solid 1px #27aa3f; border-radius: 5px; background-color: #86e397; padding: 10px 20px;'><i class='fas fa-circle-check'></i> Verifying by: $mod</div>
                            ";
                        }
                        else {
                            $verifying_by = "";
