...
<header class='header' data-header>
    <div class='container'>
        <h1 class='mt-auto pb-3'>
            <a id='btn-logo' href='https://dev.kalstein.plus/plataforma/'><img
        ...
        <nav class='navbar'>
            <div class='container'>
                ...
                <ul class='navbar-list'>
                    <li>
                        <a href='https://dev.kalstein.plus/plataforma/private-kalstein-moderator/stores'
                    ...
                    <li>
                        <a href='https://dev.kalstein.plus/plataforma/private-kalstein-moderator/guide'
                            id="link-accounts" class='navbar-link icon-box'>
                            <span data-i18n="moderator:Guides">Informational Guides</span>
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href='https://dev.kalstein.plus/plataforma/private-kalstein-moderator/products'
                            id='link-product' class='navbar-link icon-box'>
                            <span data-i18n="moderator:products">Productos</span>
                        </a>
                    </li>
                    <li>
                        <a href='https://dev.kalstein.plus/plataforma/private-kalstein-moderator/bitacoras'
                            id='link-bitacora' class='navbar-link icon-box'>
                    ...
                    <li class='generate-quote'>
                        <a href='https://dev.kalstein.plus/plataforma/moderator/quotes' class='navbar-link icon-box'
