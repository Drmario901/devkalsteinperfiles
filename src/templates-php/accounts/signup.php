            ...
            <div class='card' style='min-width: 18rem; max-width: 26rem; margin: 0 auto; margin-top: 10rem; -webkit-box-shadow: 0px 7px 34px -10px rgba(0,0,0,0.75); -moz-box-shadow: 0px 7px 34px -10px rgba(0,0,0,0.75); box-shadow: 0px 7px 34px -10px rgba(0,0,0,0.75);'>
                ...
                <div class='card-body'>
                    ...
                    <div class='col-md' style='margin-top: 1rem;'>
                        ...
                        <div class='mailExists' data-i18n="account:correoRegistrado"  style='display: none;'><p style='color: #de3a46; font-weight: bold;'>Este correo electrónico ya está registrado, intente iniciar sesión.</p></div>
                        ...
                        <div class='c-codeVerification' style='display: none;'>
                            <p data-i18n="account:verificationEmail" style='font-size: 1.3em; text-align: justify;'>Hemos enviado un correo electrónico a <span class='spanEmail' style='font-weight: bold;'></span> con el código de verificación.</p>
                            <hr>
                            <div class='form-floating'>
                                ...
                                <label for='txtCodeVerification' data-i18n="account:labelCodigo" >Verificación de códigos</label>                               
                            </div>
                            <div class='codeExpired' style='display: none;'><p style='color: #de3a46; font-weight: bold;' data-i18n="account:codigoCaducado">El código de validación ha caducado, solicite un nuevo código.</p></div>
                    ...
                    <div style="display: flex; align-items: center;">
                        ...
                        <span class='singup' style='color: #213280; cursor: pointer; font-weight: bold; margin-top: -3rem;'>
                            <a data-i18n="account:iniciarSesion" href='https://dev.kalstein.plus/plataforma/acceder/<?php echo $search != '' ? "?search=$search" : '' ?>'>Iniciar sesión</a>
                        </span>
                    </div>
                </div>
            </div>
