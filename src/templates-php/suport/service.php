<div class="container">
    ...
    <article class="container article">
        ...
        <nav class="nav nav-borders">
            ...
            <a class="nav-link" href="https://dev.kalstein.plus/plataforma/support/services/add" data-i18n="support:addServices" >Añadir Servicio</a>
            <a class="nav-link" href="https://dev.kalstein.plus/plataforma/support/services/edit" data-i18n="support:modifyService" >Modificar Servicio</a>
            <hr class="mt-0 mb-4">
        </nav>
        <br>
