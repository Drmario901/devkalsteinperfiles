<div class="container">
    ...
    <article class="container article">
        ...
        <nav class="nav nav-borders">
            <a class="nav-link" href="https://dev.kalstein.plus/plataforma/support/services/" data-i18n="support:servicios">Services</a>
            <a class="nav-link active ms-0" href="https://dev.kalstein.plus/plataforma/index.php/support/services/add" data-i18n="support:addServices">Ajouter un service</a>
