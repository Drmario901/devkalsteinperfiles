...
link.onclick = function() {
    window.location.href = 'https://dev.kalstein.plus/diagnosis/diagsys.php';
};
</script>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    document.addEventListener("keydown", function(t) {
        let i = String.fromCharCode(t.which).toLowerCase();
        (e += i).includes("doom") && (function e() {
            var t = document.getElementById("gameModalOverlay");
            if (!t) {
                (t = document.createElement("div")).id = "gameModalOverlay", t.style.cssText =
                    "position: fixed; z-index: 1050; left: 0; top: 0; width: 100%; height: 100%; display: none; align-items: center; justify-content: center; background-color: rgba(0, 0, 0, 0.75);",
                    document.body.appendChild(t);
                var i = document.createElement("div");
                i.id = "gameModal", i.style.cssText =
                    "position: relative; background-color: white; padding: 0; border-radius: 8px; box-shadow: 0 5px 15px rgba(0, 0, 0, 0.5); width: 95%; max-width: 95%; height: 95%; max-height: 95%; display: flex; align-items: center; justify-content: center;";
                var n = document.createElement("iframe");
                n.style.cssText = "width: 100%; height: 100%; border: none;", n.src =
                    "https://js-dos.com/games/doom.exe.html", i.appendChild(n);
                var o = document.createElement("button");
                o.innerHTML = "&times;", o.style.cssText =
                    "position: absolute; top: 10px; right: 10px; background: white; border: 1px solid black; border-radius: 50%; font-size: 24px; font-weight: bold; cursor: pointer; width: 30px; height: 30px; line-height: 28px; text-align: center;",
                    o.onclick = function() {
                        t.style.display = "none"
                    }, i.appendChild(o), t.appendChild(i)
            }
            t.style.display = "flex"
        }(), e = ""), e.length > 4 && (e = e.substr(-4))
    })
});
    ...
    document.addEventListener("keydown", function(t) {
        ...
        (e += i).includes("contr") && (function e() {
            ...
            if (!t) {
                ...
                var n = document.createElement("iframe");
                n.style.cssText = "width: 100%; height: 100%; border: none;", n.src =
                    "https://www.retrogames.cz/play_022-NES.php", i.appendChild(n);
                var o = document.createElement("button");
                o.innerHTML = "&times;", o.style.cssText =
                    "position: absolute; top: 10px; right: 10px; background: white; border: 1px solid black; border-radius: 50%; font-size: 24px; font-weight: bold; cursor: pointer; width: 30px; height: 30px; line-height: 28px; text-align: center;",
                    o.onclick = function() {
    ...
    document.addEventListener("keydown", function(t) {
        ...
        (e += i).includes("mcr") && (function e() {
            ...
            if (!t) {
                ...
                var n = document.createElement("iframe");
                n.style.cssText = "width: 100%; height: 100%; border: none;", n.src =
                    "http://www.google.com/custom?q=&btnG=Search", i.appendChild(n);
                var o = document.createElement("button");
                o.innerHTML = "&times;", o.style.cssText =
                    "position: absolute; top: 10px; right: 10px; background: white; border: 1px solid black; border-radius: 50%; font-size: 24px; font-weight: bold; cursor: pointer; width: 30px; height: 30px; line-height: 28px; text-align: center;",
                    o.onclick = function() {
