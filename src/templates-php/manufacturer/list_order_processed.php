<div class="container">
    ...
    <article class="container article">
        <?php
            ...
            $banner = 'banner_text_ProcessedOrders';
        ...
        <nav class="nav nav-borders">
            ...
            <a class="nav-link active" href="https://dev.kalstein.plus/plataforma/index.php/manufacturer/list-order/processed"  data-i18n='manofacturer:pedidosProcesados'>Pedidos procesados</a>
                ...
                <table class='table custom-table'>
                    <thead class='headTableForQuote'>
                        <tr>
                            ...
                            <th class='fw-bold' style='background-color: #213280; color: white; width: 150px;'  data-i18n='manofacturer:metodoEnvio'>Método de envío</th>
                            <th class='fw-bold' style='background-color: #213280; color: white; width: 150px;'  data-i18n='manofacturer:total'>Total (USD)</th>
                        ...
                        <tr>
                            <td colspan='9'>
                                <div class='contentNoDataQuote'>
                                    ...
                                    <center><p style='color: #000;'  data-i18n='manofacturer:noEncontrado'>No se encontraron datos</p></center>
                                </div>
                            </td>
                        </tr>
                    ";
