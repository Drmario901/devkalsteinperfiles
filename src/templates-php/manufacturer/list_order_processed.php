<div class="container">
    ...
    <article class="container article">
        ...
        <nav class="nav nav-borders">
            ...
            <a class="nav-link active" href="https://plataforma.kalstein.net/index.php/manufacturer/list-order/processed"  data-i18n='manofacturer:pedidosProcesados'>Pedidos procesados</a>
