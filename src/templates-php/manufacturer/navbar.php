...
<div class="container">
    <h1 class='mt-auto pb-3'>
        <a id='btn-logo' href='https://dev.kalstein.plus/plataforma/index.php/fabricante/dashboard'><img
    ...
    <nav class="navbar">
        <div class="container">
            ...
            <ul class="navbar-list">
                <div class="d-flex flex-row">
                    <li>
                        ...
                        <a href='https://dev.kalstein.plus/plataforma/index.php/fabricante/inbox/' id='link-mail'
                    ...
                    <li>
                        <a href='https://dev.kalstein.plus/plataforma/index.php/fabricante/configuracion/'
                            id='link-config' class='navbar-link icon-box'>
            ...
            <ul class="navbar-list">
                ...
                <li>
                    <a id="link-home" href="https://dev.kalstein.plus/plataforma/index.php/fabricante/dashboard"
                        class="navbar-link icon-box">
                        <span>Dashboard</span>
                    </a>
                </li>
                ...
                <li>
                    <a id="link-stock" href="https://dev.kalstein.plus/plataforma/index.php/fabricante/productos"
                        class="navbar-link icon-box">
                ...
                <li>
                    <a id="link-list-order" href="https://dev.kalstein.plus/plataforma/index.php/fabricante/ordenes"
                        class="navbar-link icon-box">
                ...
                <li>
                    <a id="link-catalogs" href="https://dev.kalstein.plus/plataforma/index.php/fabricante/catalogos"
                        class="navbar-link icon-box">
                ...
                <li>
                    <a id="link-sales-report" href="https://dev.kalstein.plus/plataforma/index.php/fabricante/ventas"
                        class="navbar-link icon-box">
                ...
                <li class='generate-quote'> <!-- only style class-->
                    <a id='btnGenQuote'
                        href="https://dev.kalstein.plus/plataforma/index.php/fabricante/productos/agregar"
        ...
        <script
            src="https://dev.kalstein.plus/plataforma/wp-content/plugins/kalsteinPerfiles/kalsteinCotizacion/assets/js/script.cot2.lite.manu.js"></script>
    </nav>
</div>
