    ...
    <table class="membership-table">
        <thead>
          ...
          color: <?php echo $membresia == 1 ? '#FFFFFF' : 'inherit'; ?>;">
                    <?php if ($membresia == 1) echo "<span style='font-size: 12px; font-weight: 400; color: #FFFFFF;'><i class='fa-solid fa-circle-exclamation'</i> Suscripción actual</span>"; ?>
                    Membresía 2<br>
          ...
          color: <?php echo $membresia == 2 ? '#FFFFFF' : 'inherit'; ?>;">
                    <?php if ($membresia == 2) echo "<span style='font-size: 12px; font-weight: 400; color: #FFFFFF;'><i class='fa-solid fa-circle-exclamation'</i> Suscripción actual</span>"; ?>
                    Membresía 3<br>
