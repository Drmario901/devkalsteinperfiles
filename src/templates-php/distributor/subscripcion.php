...
<section style="margin-top: 2rem;">
  ...
  <div id='tbl-botones' style="display: flex; justify-content: center; gap: 2rem; margin-top: 1.5rem;">
    <?php if ($membresia != 0) : ?>
      <a href="https://dev.kalstein.plus/plataforma/wp-content/plugins/kalsteinPerfiles/php/testPayRecurrentCancel.php" id="btn-cancelar-subs" class="btn-tbl-cancelar">Cancelar</a>
    <?php endif; ?>
