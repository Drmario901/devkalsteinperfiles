<div class="container">
    ...
    <?php
        ...
        $language = isset($_COOKIE['language']) ? $_COOKIE['language'] : 'en';
            ...
            $banner_text_translation = isset($translations[$language]['banner_text_sales_report']) ? $translations[$language]['banner_text_sales_report'] : $translations['en']['banner_text_sales_report'];
