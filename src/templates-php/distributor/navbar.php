            ...
            <ul class="navbar-list">
                <div class="d-flex flex-row">
                    <li title="Redireccionar a subscripcion">
                        <a href="https://dev.kalstein.plus/plataforma/distribuidor/subscripcion/" class='navbar-link icon-box'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-credit-card navbar-link icon-box" viewBox="0 0 16 16">
