...
?>
<style>
    .tm-edit-product-form input,
    .tm-edit-product-form select {
        border-color: #999;
    ...
    .tm-edit-product-form input::placeholder,
    .tm-edit-product-form textarea::placeholder {
        color: #bbb;
    }
    ...
    .table-editor-selector:first-child,
    .table-editor-selector:nth-child(2) {
    ...
    #stock-table-keys>div>input,
    #stock-table-values>div>input {
        padding: 12px;
        width: 100%;
        height: 100%;
        margin: 0;
...
<form method="post" class="tm-edit-product-form">
    <div class="row">
        ...
        <div class="col-12 col-md-6">
            ...
            <input id="nameProduct" type="text" class="form-control validate mb-3"
                data-placeholder="distribuidor:labelNombre" placeholder="Nombre" />


            <!-- no fake brand input -->
            <label data-i18n="distribuidor:labelMarca">Marca</label>
            <input style="color: #000 !important;" id="brandProduct" type="text" class="form-control validate"
                data-placeholder="distribuidor:labelMarca" placeholder="Marca" />

            <label data-i18n="distribuidor:labelModelo">Modelo</label>
            <input id="modelProduct" type="text" class="form-control validate mb-3"
                data-placeholder="distribuidor:labelModelo" placeholder="Modelo" />
        ...
        <div class="col-12 col-md-6 mb-4">
            ...
            <div class="custom-file mt-3 mb-3">
                <label for="file-input" class="drop-container" id="dropcontainerImage">
                    <span class="drop-title" data-i18n="distribuidor:labelDragAndDrop">Selecciona o arrastra y suelta
                        una imágen</span>
                    <img class="drop-image"
                        src="https://dev.kalstein.plus/plataforma/wp-content/plugins/kalsteinPerfiles/src/images/IMAGE-document.png"
                        alt="pdf">
                    <img id="thumbnail" />
                </label>
        ...
        <div class="col-12 mb-4">
            ...
            <textarea style="height: 200px" id="descriptionProduct" class="form-control validate tm-small"
                data-placeholder="distribuidor:placeholderDescripcion" placeholder="Describe tu producto en menos de 5000 carácteres
            "></textarea>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-12">
            ...
            <div id="stock-excel-table" class="mb-4" hidden data-i18n="distribuidor:archivoExcelCSV">
                ...
                <span data-i18n="distribuidor:textHaveHeader">Tiene cabecera<input type="checkbox" id="has_headers"
                        style="border-radius: 0" class="d-inline"></span>
        ...
        <div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 form-group mb-3">
                    ...
                    <select class="custom-select tm-select-accounts" id="subCategorySelect" name="subCategorySelect"
                        disabled>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-6 col-xsm-12">
                    <h6 class="tm-block-title mb-0"><span data-i18n="distribuidor:labelSubtitleProduct">Producto</span>
                        <i class="fas fa-microscope"></i></h6>
                    <label data-i18n="distribuidor:labelPesoNeto">Peso neto (kg)</label>
                    <input id="weProduct" type="number" step="0.01" placeholder="0.00"
                        class="form-control validate mb-1" data-large-mode="true" min="0" />

                    <label data-i18n="distribuidor:labelAncho">Ancho (cm)</label>
                    <input id="wiProduct" type="number" placeholder="0.00" class="form-control validate mb-1" min="0" />

                    <label data-i18n="distribuidor:labelAlto">Alto (cm)</label>
                    <input id="heProduct" type="number" placeholder="0.00" class="form-control validate mb-1" min="0" />

                    <label data-i18n="distribuidor:labelLargo">Largo (cm)</label>
                    <input id="leProduct" type="number" placeholder="0.00" class="form-control validate mb-1" min="0" />
                </div>
                <!-- PACKAGED -->
                <div class=" col-sm-6 col-xsm-12">
                    <h6 class="tm-block-title mb-0"><span data-i18n="distribuidor:subtitleEmpaque">Empaque</span> <i
                            class="fas fa-box"></i></h6>
                    <label data-i18n="distribuidor:labelPesoBruto">Peso bruto (kg)</label>
                    <input id="weProductPa" type="number" step="0.01" placeholder="0.00"
                        class="form-control validate mb-1" data-large-mode="true" min="0" />

                    <label data-i18n="distribuidor:labelAncho">Ancho (cm)</label>
                    <input id="wiProductPa" type="number" placeholder="0.00" class="form-control validate mb-1"
                        min="0" />

                    <label data-i18n="distribuidor:labelAlto">Alto (cm)</label>
                    <input id="heProductPa" type="number" placeholder="0.00" class="form-control validate mb-1"
                        min="0" />

                    <label data-i18n="distribuidor:labelLargo">Largo (cm)</label>
                    <input id="leProductPa" type="number" placeholder="0.00" class="form-control validate mb-1"
                        min="0" />

                    <label data-i18n="distribuidor:labelTipoEmpaque">Tipo de empaque</label>
                    <select id="packageType">
                        <option class="text-dark" value="" data-i18n="distribuidor:optionSelecciona">-- Selecciona --
                        </option>
                        <option class="text-dark" value="carton" data-i18n="distribuidor:CajaDeCarton">Caja de cartón
                        </option>
                        <option class="text-dark" value="wooden" data-i18n="distribuidor:CajaDeMadera">Caja de madera
                        </option>
                    </select>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="form-group mb-3 col-sm-6 col-xsm-12">
                    ...
                    <input id="priceProduct" type="number" step="0.01" placeholder="0.00"
                        class="form-control mb-1 validate" min="0" />
                </div>
                <div class="form-group mb-3 col-sm-6 col-xsm-12">
                    <label><span data-i18n="distribuidor:subtitleMoneda">Moneda</span> <i
                            class="far fa-money-bill-1 h5"></i></i></label>
                    <select id="currency">
                        <option class="text-dark" value="" data-i18n="distribuidor:optionSelecciona">-- Selecciona --
                        </option>
                ...
                <h6 class="tm-block-title mb-0" data-i18n="distribuidor:subtitleDescuentoUno">Descuento mayorista 1
                    (opcional)</h6>
                <div class='form-group col-12 mb-3 ms-3'>
                    <span data-i18n="distribuidor:spanAplica">Aplica </span>
                    <input style="width: 45px;" id="discount1" type="number" placeholder="0"
                        class="form-control validate mb-2 d-inline-block stock-special-input" min="0" max="100" />
                    <span data-i18n="distribuidor:spanDescuento">% descuento de </span>
                    <input style="width: 55px;" id="discount1Amount" type="number" placeholder="24"
                        class="form-control validate d-inline-block stock-special-input" min="0" />
                    <span data-i18n="distribuidor:spanUnidades">unidades</span>
                </div>

                <h6 class="tm-block-title mb-0" data-i18n="distribuidor:subtitleDescuentoDos">Descuento mayorista 2
                    (opcional)</h6>
                <div class='form-group col-12 mb-3 ms-3'>
                    <span data-i18n="distribuidor:spanAplica">Aplica </span>
                    <input style="width: 45px;" id="discount2" type="number" placeholder="0"
                        class="form-control validate mb-2 d-inline-block stock-special-input" min="0" max="100" />
                    <span data-i18n="distribuidor:spanDescuento">% descuento de </span>
                    <input style="width: 55px;" id="discount2Amount" type="number" placeholder="50"
                        class="form-control validate d-inline-block stock-special-input" min="0" />
                    <span data-i18n="distribuidor:spanUnidades">unidades</span>
                </div>
            </div>
            ...
            <div class="row mb-3 d-flex justify-content-center">
                <div class="accordion col-12 col-md-8" id="accordionExample">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseOne" class="accordion-collapse show mx-3" aria-labelledby="headingOne"
            ...
            <div class="row">
                <div class="col-12 col-md-6 mb-3 p-4">
                    ...
                    <label for="catalogPDF" class="drop-container" id="dropcontainerCatalog">
                        <span class="drop-title" data-i18n="distribuidor:dragAndDrop">Selecciona o arrastra y suelta tu
                            archivo</span>
                        <img class="drop-image"
                            src="https://dev.kalstein.plus/plataforma/wp-content/plugins/kalsteinPerfiles/src/images/PDF-document-upload.png"
                            alt="pdf">
                    </label>
