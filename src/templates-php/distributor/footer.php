<footer class="footer-kalstein" style="background-image: linear-gradient(rgba(33,50,128, 0.75), rgba(23,35,89, 0.75)), url('https://dev.kalstein.plus/plataforma/wp-content/plugins/kalsteinPerfiles/src/images/banner-footer/<?php echo $footer_img ?>');">
    <div class="container">
        <div>
