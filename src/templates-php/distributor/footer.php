<footer class="footer-kalstein" style="background-image: linear-gradient(rgba(33,50,128, 0.5), rgba(33,50,128, 0.5)), url('https://dev.kalstein.plus/plataforma/wp-content/plugins/kalsteinPerfiles/src/images/banner-footer/<?php echo $footer_img ?>');">
    <div class="container">
        <div>
