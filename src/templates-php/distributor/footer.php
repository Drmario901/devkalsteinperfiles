<footer class="footer-kalstein" style="background-image: linear-gradient(rgba(33,50,128, 0.15), rgba(33,50,128, 0.15)), url('https://dev.kalstein.plus/plataforma/wp-content/plugins/kalsteinPerfiles/src/images/banner-footer/<?php echo $footer_img ?>');">
    <div class="container">
        <div>
        ...
        <div>
            <h5 data-i18n="distribuidor:h5ServiceConsumer">Servicio al consumidor</h5>
            <ul>
                <li class="footer-item">
                    <a href="#" data-i18n="distribuidor:linkChatOnline">Chat en línea</a>
                </li>
    
                <li class="footer-item">
                    <a href="#" data-i18n="distribuidor:linkSendEmail">Enviar un correo</a>
                </li>
            </ul>
        </div>
        <div>
            <h5 data-i18n="distribuidor:h5followUs">Síguenos</h5>
            <ul>
