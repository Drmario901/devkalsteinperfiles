  ...
  document
    ...
    .addEventListener("click", function (event) {
      ...
      jQuery(document).ready(function ($) {
        ...
        var idsInputs = document.querySelector(
          'input[name="ids_inputs"]'
        ).value;
        ...
        $.ajax({
          ...
          success: function (response) {
            ...
            if (
              response.includes(
                "Todos los archivos han sido subidos correctamente"
              ) ||
              response.includes("No se han seleccionado archivos para subir")
            ) {
      ...
      function ejecutarRestoDelCodigo() {
        ...
        function aplicarEstiloSiCumpleCondicion(
          elemento,
          propiedadCSS,
          valorCondicion,
          texto
          ...
          if (
            elemento.styles[propiedadCSS] === valorCondicion ||
            elemento.styles[propiedadCSS] == valorCondicion
          ) {
        ...
        function aplicarEstiloSiNoCumpleCondicion(
          elemento,
          propiedadCSS,
          valorCondicion,
          texto
        ...
        aplicarEstiloSiCumpleCondicion(
          p1Img01,
          "display",
          "none",
          " #PDFp1Img01 {position: absolute; top: -9999px;}"
        );
        aplicarEstiloSiCumpleCondicion(
          p1Img01,
          "right",
          "94.4882px",
          " #PDFp1Img01 {float:right; margin-left:0mm;}"
        );
        aplicarEstiloSiCumpleCondicion(
          p1Img01,
          "right",
          "306.142px",
          " #PDFp1Img01 {float:left; margin-left:90mm;}"
        );
        aplicarEstiloSiCumpleCondicion(
          p1Img01,
          "right",
          "521.575px",
          " #PDFp1Img01 {float:left; margin-left:20mm;}"
        ); //sm y md
        aplicarEstiloSiCumpleCondicion(
          p1Img01,
          "right",
        ...
        aplicarEstiloSiCumpleCondicion(
          ...
          "right",
          "291.024px",
          " #PDFp1Img01 {float:left; margin-left:80mm;}"
        );
        aplicarEstiloSiCumpleCondicion(
          p1Img01,
          "right",
        ...
        aplicarEstiloSiCumpleCondicion(
          ...
          "display",
          "none",
          " #PDFlogoP1 {position: absolute; top: -9999px;}.PDFhr{position: absolute; top: -9999px;}"
        );
        aplicarEstiloSiCumpleCondicion(
          p1Img02,
          "top",
          "610.772px",
          " #PDFLogoP1 {margin-top: 58mm;}"
        );
        aplicarEstiloSiCumpleCondicion(
          p1Img02,
          "top",
          "597.921px",
          " #PDFLogoP1 {margin-top: 54mm;}"
        );
        aplicarEstiloSiCumpleCondicion(
          p1Img02,
          "top",
          "585.071px",
          " #PDFLogoP1 {margin-top: 50mm;}"
        ); //md
        aplicarEstiloSiCumpleCondicion(
          p1Img02,
          "width",
    ...
    templateTextFontSize('p1T1P3','PDFmsj'); */
        aplicarEstiloSiNoCumpleCondicion(
          p1TituloP1,
          "color",
          "rgb(51, 51, 51)",
          " .PDFco {color:" + p1TituloP1.styles.color + ";}"
        );
        aplicarEstiloSiNoCumpleCondicion(
          p1TituloP2,
          "color",
          "rgb(33, 50, 128)",
          " .PDFid-title , .PDFid-n {color:" +
            p1TituloP2.styles.color +
            " !important;}"
        );
        aplicarEstiloSiNoCumpleCondicion(
          p1TituloP3,
          "color",
          "rgb(51, 51, 51)",
          " .PDFmsj {color:" + p1TituloP3.styles.color + ";}"
        );
        aplicarEstiloSiNoCumpleCondicion(
          p1TituloP1,
          "textAlign",
          "left",
          " .PDFco {text-align:" + p1TituloP1.styles.textAlign + ";}"
        );
        aplicarEstiloSiNoCumpleCondicion(
          p1TituloP2,
          "textAlign",
          "left",
          " .PDFid-title , .PDFid-n {text-align:" +
            p1TituloP2.styles.textAlign +
            ";}"
        );
        aplicarEstiloSiNoCumpleCondicion(
          p1TituloP3,
          "textAlign",
          "left",
          " .PDFmsj {text-align:" + p1TituloP3.styles.textAlign + ";}"
        );
        aplicarEstiloSiCumpleCondicion(
          p1TituloP1,
          "fontWeight",
          "700",
          " .PDFco {font-weight: bold;}"
        );
        aplicarEstiloSiCumpleCondicion(
          p1TituloP2,
          "fontWeight",
          "700",
          " .PDFid-title , .PDFid-n {font-weight: bold;}"
        );
        aplicarEstiloSiCumpleCondicion(
          p1TituloP3,
          "fontWeight",
          "700",
          " .PDFmsj {font-weight: bold;}"
        );
        aplicarEstiloSiCumpleCondicion(
          p1TituloP1,
          "fontWeight",
          "400",
          " .PDFco {font-weight: lighter;}"
        );
        aplicarEstiloSiCumpleCondicion(
          p1TituloP2,
          "fontWeight",
          "400",
          " .PDFid-title , .PDFid-n {font-weight: lighter;}"
        );
        aplicarEstiloSiCumpleCondicion(
          p1TituloP3,
          "fontWeight",
          "400",
          " .PDFmsj {font-weight: lighter;}"
        );
    ...
    aplicarEstiloSiNoCumpleCondicion(p1TituloP3, 'fontFamily', 'Arial, Helvetica, sans-serif', ' .PDFmsj {font-family: ' + (p1TituloP3.styles.fontFamily) + ';}');  */
        ...
        aplicarEstiloSiCumpleCondicion(
          ...
          "display",
          "none",
          " .PDFbackground-img {position: absolute; left: -9999px;}"
        );
        ...
        aplicarEstiloSiCumpleCondicion(
          ...
          "display",
          "none",
          " #PDFLogo2P1 {position: absolute; top: -9999px;}.PDFhr-2{position: absolute; top: -9999px;}"
        );
        aplicarEstiloSiCumpleCondicion(
          p1Img03Cont,
          "top",
          "1020.47px",
          " .PDFimg-logo2 {top: 258mm;}"
        );
        aplicarEstiloSiCumpleCondicion(
          p1Img03Cont,
          "top",
          "1009.13px",
          " .PDFimg-logo2 {top: 256mm;}"
        );
        aplicarEstiloSiCumpleCondicion(
          p1Img03Cont,
          "top",
          "997.795px",
          " .PDFimg-logo2 {top: 252mm;}"
        ); //md
        aplicarEstiloSiCumpleCondicion(
          p1Img03,
          "width",
          ...
          " #PDFLogo2P1 {width:" +
            ...
            "px !important; height:" +
            92.7656 +
            "px;} .PDFimg-logo2 {margin-right: -8mm;padding-top:3mm}"
        );
        aplicarEstiloSiCumpleCondicion(
          p1Img03,
          "width",
        ...
        aplicarEstiloSiCumpleCondicion(
          ...
          " #PDFLogo2P1 {width:" +
            ...
            "px !important; height:" +
            133 +
            "px;} .PDFimg-logo2 {margin-right: 2mm;}"
        );
        ...
        aplicarEstiloSiNoCumpleCondicion(
          ...
          "color",
          "rgb(255, 255, 255)",
          " .PDFl-1 {color:" + p1FooterP1.styles.color + ";}"
        );
        aplicarEstiloSiNoCumpleCondicion(
          p1FooterP2,
          "color",
          "rgb(255, 255, 255)",
          " .PDFl-2 {color:" + p1FooterP2.styles.color + ";}"
        );
        aplicarEstiloSiNoCumpleCondicion(
          p1FooterP3,
          "color",
          "rgb(255, 255, 255)",
          " .PDFl-3 {color:" + p1FooterP3.styles.color + ";}"
        );
        aplicarEstiloSiNoCumpleCondicion(
          p1FooterP4,
          "color",
          "rgb(255, 255, 255)",
          " .PDFl-4 {color:" + p1FooterP4.styles.color + ";}"
        );
        aplicarEstiloSiNoCumpleCondicion(
          p1FooterP5,
          "color",
          "rgb(255, 255, 255)",
          " .PDFl-5 {color:" + p1FooterP5.styles.color + ";}"
        );
        aplicarEstiloSiNoCumpleCondicion(
          p1FooterP1,
          "textAlign",
          "left",
          " .PDFl-1 {text-align:" + p1FooterP1.styles.textAlign + ";}"
        );
        aplicarEstiloSiNoCumpleCondicion(
          p1FooterP2,
          "textAlign",
          "left",
          " .PDFl-2 {text-align:" + p1FooterP2.styles.textAlign + ";}"
        );
        aplicarEstiloSiNoCumpleCondicion(
          p1FooterP3,
          "textAlign",
          "left",
          " .PDFl-3 {text-align:" + p1FooterP3.styles.textAlign + ";}"
        );
        aplicarEstiloSiNoCumpleCondicion(
          p1FooterP4,
          "textAlign",
          "left",
          " .PDFl-4 {text-align:" + p1FooterP4.styles.textAlign + ";}"
        );
        aplicarEstiloSiNoCumpleCondicion(
          p1FooterP5,
          "textAlign",
          "left",
          " .PDFl-5 {text-align:" + p1FooterP5.styles.textAlign + ";}"
        );
        aplicarEstiloSiCumpleCondicion(
          p1FooterP1,
          "fontWeight",
          "700",
          " .PDFl-1 {font-weight: bold;}"
        );
        aplicarEstiloSiCumpleCondicion(
          p1FooterP2,
          "fontWeight",
          "700",
          " .PDFl-2 {font-weight: bold;}"
        );
        aplicarEstiloSiCumpleCondicion(
          p1FooterP3,
          "fontWeight",
          "700",
          " .PDFl-3 {font-weight: bold;}"
        );
        aplicarEstiloSiCumpleCondicion(
          p1FooterP4,
          "fontWeight",
          "700",
          " .PDFl-4 {font-weight: bold;}"
        );
        aplicarEstiloSiCumpleCondicion(
          p1FooterP5,
          "fontWeight",
          "700",
          " .PDFl-5 {font-weight: bold;}"
        );
        aplicarEstiloSiCumpleCondicion(
          p1FooterP1,
          "fontWeight",
          "400",
          " .PDFl-1 {font-weight: lighter;}"
        );
        aplicarEstiloSiCumpleCondicion(
          p1FooterP2,
          "fontWeight",
          "400",
          " .PDFl-2 {font-weight: lighter;}"
        );
        aplicarEstiloSiCumpleCondicion(
          p1FooterP3,
          "fontWeight",
          "400",
          " .PDFl-3 {font-weight: lighter;}"
        );
        aplicarEstiloSiCumpleCondicion(
          p1FooterP4,
          "fontWeight",
          "400",
          " .PDFl-4 {font-weight: lighter;}"
        );
        aplicarEstiloSiCumpleCondicion(
          p1FooterP5,
          "fontWeight",
          "400",
          " .PDFl-5 {font-weight: lighter;}"
        );
        ...
        aplicarEstiloSiCumpleCondicion(
          ...
          "display",
          "none",
          " #PDFf-01-img {position: absolute; top: -9999px;}"
        );
        ...
        aplicarEstiloSiCumpleCondicion(
          ...
          "display",
          "none",
          " #PDFlogoP2 {position: absolute; top: -9999px;}"
        );
        aplicarEstiloSiCumpleCondicion(
          p2logo,
          "width",
        ...
        aplicarEstiloSiCumpleCondicion(
          ...
          "width",
          "249px",
          " #PDFlogoP2 {width:" + 249 + "px !important; height:" + 73 + "px;}"
        );
        aplicarEstiloSiCumpleCondicion(
          p2logo,
          "width",
          ...
          " #PDFlogoP2 {width:" +
            ...
            "px !important; height:" +
            88.2656 +
            "px; margin-top: 7mm; margin-left: -12mm;}"
        );
        ...
        aplicarEstiloSiNoCumpleCondicion(
          ...
          "color",
          "rgb(255, 255, 255)",
          " .PDFc-table td {color:" + p2Tabla.styles.color + ";}"
        );
        aplicarEstiloSiNoCumpleCondicion(
          p2Tabla,
          "backgroundColor",
          "rgb(33, 50, 128)",
          " .PDFc-table td {background-color:" +
            p2Tabla.styles.backgroundcolor +
            ";}"
        );
        ...
        aplicarEstiloSiNoCumpleCondicion(
          ...
          "color",
          "rgb(51, 51, 51)",
          " .PDFbt-02 p {color:" + p2Factura.styles.color + ";}"
        );
        ...
        aplicarEstiloSiCumpleCondicion(
          ...
          "display",
          "none",
          " #PDFimg-ce-img {position: absolute; top: -9999px;}"
        );
        ...
        aplicarEstiloSiCumpleCondicion(
          ...
          "display",
          "none",
          " #PDFimg-cora-img {position: absolute; top: -9999px;}"
        );
        ...
        aplicarEstiloSiNoCumpleCondicion(
          ...
          "color",
          "rgb(51, 51, 51)",
          " .PDFtext-ce p {color:" + p2Footer1P1.styles.color + ";}"
        );
        aplicarEstiloSiNoCumpleCondicion(
          p2Footer1P2,
          "color",
          "rgb(51, 51, 51)",
          " .PDFtext-cora p {color:" + p2Footer1P2.styles.color + ";}"
        );
        ...
        aplicarEstiloSiNoCumpleCondicion(
          ...
          "color",
          "rgb(51, 51, 51)",
          " .PDFft-02-text p {color:" + p2Footer2P1.styles.color + ";}"
        );
        ...
        aplicarEstiloSiCumpleCondicion(
          ...
          "display",
          "none",
          " #PDFlogo4-02-img {position: absolute; top: -9999px;}"
        );
        aplicarEstiloSiCumpleCondicion(
          p3Logo,
          "width",
          "210px",
          " #PDFlogo4-02-img {width:" +
            210 +
            "px !important; height:" +
            61.7969 +
            "px;}"
        ...
        aplicarEstiloSiNoCumpleCondicion(
          ...
          "color",
          "rgb(33, 50, 128)",
          " .PDFlt4-01 {color:" + p3Titulo.styles.color + ";}"
        );
        ...
        aplicarEstiloSiNoCumpleCondicion(
          ...
          "color",
          "rgb(33, 50, 128)",
          " .PDFp3ST {color:" + p3Subtitulos.styles.color + ";}"
        );
        aplicarEstiloSiNoCumpleCondicion(
          p3Parrafos,
          "color",
        ...
        aplicarEstiloSiCumpleCondicion(
          ...
          "display",
          "none",
          " #PDFp2img-02-img {position: absolute; top: -9999px;}"
        );
        ...
        aplicarEstiloSiCumpleCondicion(
          ...
          "display",
          "none",
          " #PDFp2img-03-img {position: absolute; top: -9999px;}"
        );
        ...
        aplicarEstiloSiCumpleCondicion(
          ...
          "backgroundColor",
          "rgb(255, 255, 255)",
          " .PDFstyle-05 {background-color: white;}"
        );
        aplicarEstiloSiCumpleCondicion(
          p3Stl02,
          "backgroundColor",
          "rgb(255, 255, 255)",
          " .PDFstyle-07 {background-color: white;} #PDFstyle-07-p1 {color: black;}"
        );
        aplicarEstiloSiNoCumpleCondicion(
          p3Stl01,
          "backgroundColor",
          "rgb(33, 50, 128)",
          " .PDFstyle-05 {background-color:" +
            p3Stl01.styles.backgroundColor +
            ";}"
        );
        aplicarEstiloSiNoCumpleCondicion(
          p3Stl02,
          "backgroundColor",
          "rgb(33, 50, 128)",
          " .PDFstyle-07 {background-color:" +
            p3Stl02.styles.backgroundColor +
            ";}"
        );
        aplicarEstiloSiNoCumpleCondicion(
          p3FooterP,
          "color",
          "rgb(255, 255, 255)",
          " #footerP {color:" + p3FooterP.styles.color + ";}"
        );
        ...
        fetch(
          "https:///dev.kalstein.plus/plataforma/wp-content/plugins/kalsteinPerfiles/php/customizeTemplateQuerys.php",
          {
            method: "POST",
            headers: {
            ...
            body:
              ...
              "&template_mail=" +
              encodeURIComponent(emailAcc) +
              "&template_variables=" +
              encodeURIComponent(varsPhp) +
              "&template_user=" +
          ...
          .then((data) => {
            ...
            let url =
              "https:///dev.kalstein.plus/plataforma/wp-content/plugins/kalsteinPerfiles/kalsteinCotizacion/classes/createCustomPDF.php";
