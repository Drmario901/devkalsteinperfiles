...
document
  .querySelector("#titleColorOption")
  .addEventListener("click", function () {
    let t1 = document.querySelector(".co");
    let t2 = document.querySelector(".id-title");
    let t3 = document.querySelector(".msj");
...
document
  .querySelector("#titleAlignOption")
  .addEventListener("click", function () {
    let t1 = document.querySelector(".co");
    let t2 = document.querySelector(".id-title");
    let t3 = document.querySelector(".msj");
...
document.querySelector("#p1ImgDiv").addEventListener("click", function (event) {
  if (
    !event.target.closest("#p1Img01BtnClearG") &&
    !event.target.closest("#p1Img02BtnClearG") &&
    !event.target.closest("#p1Img03BtnClearG")
  ) {
...
/* Fondo */
document
  .querySelector("#p1BackgroundCheck")
  .addEventListener("change", function () {
    ...
    if (checkbox.checked) {
      ...
      img.src =
        "https://dev.kalstein.plus/plataforma/wp-content/plugins/kalsteinPerfiles/kalsteinCotizacion/assets/images/k+blanco.png";
    } else {
      elementToShowHide.style.display = "none";
      texto.style.color = "#333";
      img.src =
        "https://dev.kalstein.plus/plataforma/wp-content/plugins/kalsteinPerfiles/kalsteinCotizacion/assets/images/k+azul.png";
    }
  });
  ...
  .addEventListener("click", function (event) {
    if (!event.target.closest("#p1Img01BtnClearG")) {
      ...
      alignBtnLeft.addEventListener("click", function () {
        ...
        if (currentSizeStyles.width === "172.156px") {
          // MD
          currentAlignmentStyles.right = "138mm";
        } else if (currentSizeStyles.width === "210.047px") {
          // LG
...
/* Cambiar imagen 01 */
document
  .getElementById("p1Img01FileInput")
...
/* Default all p1Img01 */
document
  .querySelector("#p1Img01BtnClearG")
  .addEventListener("click", function () {
    let displayCheckbox = document.querySelector("#p1Img01Display");
    let imagenPredeterminadaSrc =
      "https://platform.kalstein.us/wp-content/plugins/kalsteinPerfiles/kalsteinCotizacion/assets/images/francia-pais.jpg";
    let imagenExistente = document.getElementById("p1Img01");
...
document
  ...
  .addEventListener("click", function (event) {
    if (!event.target.closest("#p1Img02BtnClearG")) {
      ...
      let p1ImgOptionsFlexList = document.querySelectorAll(
        ".p1ImgOptionsFlex02"
      );
...
/* Cambiar imagen 02 */
document
  .getElementById("p1Img02FileInput")
  .addEventListener("change", function (event) {
    /* if (disp !== 2){ */
...
/* Default all p1Img02 */
document
  .querySelector("#p1Img02BtnClearG")
  .addEventListener("click", function () {
    /* if (disp !== 2){ */
    let displayCheckboxImg02 = document.querySelector("#p1Img02Display");
    let imagenPredeterminadaSrc =
...
/* Cambiar imagen 03 */
document
  .getElementById("p1Img03FileInput")
  .addEventListener("change", function (event) {
    let file = event.target.files[0]; // Obtener el archivo de la entrada de archivos
...
/* Default all p1Img03 */
document
  .querySelector("#p1Img03BtnClearG")
  .addEventListener("click", function () {
...
//texto
document
  .querySelector("#p1FooterTextOption")
  .addEventListener("click", function () {
    ...
    btnClear.addEventListener("click", function () {
      let defaultContent1 =
        "Todos los derechos reservados ® KALSTEIN France S. A. S.";
...
//color
document
  .querySelector("#p1FooterColorOption")
  .addEventListener("click", function () {
    let p1 = document.querySelector(".l-1");
    let p2 = document.querySelector(".l-2");
    let p3 = document.querySelector(".l-3");
...
// alineacion
document
  .querySelector("#p1FooterAlignOption")
  .addEventListener("click", function () {
...
// negritas
document
  .querySelector("#p1FooterBoldPicker")
  .addEventListener("click", function () {
    let texto = document.querySelectorAll(".p1FooterP");
...
// default all Footer
document
  .querySelector("#p1FooterBtnClearG")
  .addEventListener("click", function () {
    let qr = document.querySelector(".qr");
    let hr = document.querySelector(".hr-2");
    let textContainer = document.querySelector(".f-text");
