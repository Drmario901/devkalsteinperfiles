...
document
  .getElementById("p3Img01FileInput")
...
document
  .getElementById("p3Img01BtnClearG")
...
document
  .getElementById("p3Img02FileInput")
  .addEventListener("change", function (event) {
    let file = event.target.files[0];
...
document
  .getElementById("p3Img02BtnClearG")
  .addEventListener("click", function () {
    ...
    img.style.display = "block";
    img.src =
      "https://dev.kalstein.plus/plataforma/wp-content/plugins/kalsteinPerfiles/kalsteinCotizacion/assets/images/img2p.png";
    checkbox.checked = true;
    p3Img03.style.bottom = "3mm";
  });
...
document
  .getElementById("p3Img03FileInput")
  .addEventListener("change", function (event) {
    let file = event.target.files[0];
...
document
  .getElementById("p3Img03BtnClearG")
  .addEventListener("click", function () {
    ...
    img.style.display = "block";
    img.src =
      "https://dev.kalstein.plus/plataforma/wp-content/plugins/kalsteinPerfiles/kalsteinCotizacion/assets/images/img1p.png";
    checkbox.checked = true;
    p3Img02.style.top = "79.9mm";
  });
...
// default all titulo
document
  .querySelector("#p3TitleBtnClearG")
  .addEventListener("click", function () {
    //Color
...
document
  .querySelector("#p3TitleColorSaveButton")
  .addEventListener("click", function () {
...
document
  .querySelector("#p3TitleColorBtnClear")
  .addEventListener("click", function () {
    document.querySelector("#p3TitleColorPicker").value = "#213280";
    let color = "";
    let text = document.querySelectorAll(".lt4-01");
...
document
  ...
  .addEventListener("click", function () {
    ...
    let text2 = document.querySelectorAll(
      ".i-list p, .i-txt p, .i-txt2 p, .i-txt3 p, .i-txt4 p, .i-txt5 p, .i-txt6 p"
    );
...
document
  .querySelector("#p3TextColorBtnClear")
  .addEventListener("click", function () {
    document.querySelector("#p3TextColorPicker1").value = "#213280";
    document.querySelector("#p3TextColorPicker2").value = "";
    let color = "#213280";
...
document
  .querySelector("#p3StlColorSaveButton")
  .addEventListener("click", function () {
...
document
  .querySelector("#p3StlColorBtnClear")
  .addEventListener("click", function () {
    let color = "#213280";
    let stl = document.querySelector(".style-05");
    let color2 = "#ffffff";
