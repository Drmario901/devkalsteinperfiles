jQuery(document).ready(function () {
  ...
  function generarTabla(datos) {
    let tablaHtml =
      '<table class="table"><thead><tr><th>ID</th><th>ID Cotización</th><th>Monto Total</th><th>Divisa</th><th>ID Remitente</th><th>Estado del Pago</th></tr></thead><tbody>';
    datos.forEach((fila) => {
      let status = "";
  ...
  function generarPaginado(paginas) {
    ...
    for (let i = 1; i <= paginas; i++) {
      ...
      botonesPagina += `<li class="page-item ${claseActiva}"><buttson class="page-link" data-pagina="${i}">${i}</buttson></li>`;
    }
