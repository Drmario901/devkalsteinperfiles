...
$date = urlencode('23/05/2024_a_16:26:35'); // Fecha y hora de la transacción original codificada en URL
$date_commande = urlencode('23/05/2024'); // Solo la fecha de la transacción original codificada en URL
